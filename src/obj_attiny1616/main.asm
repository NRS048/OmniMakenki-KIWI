...
obj_attiny1616/main.elf:     file format elf32-avr
...
000000a6 <.do_clear_bss_start>:
      ...
      b0:	0c 94 15 17 	jmp	0x2e2a	; 0x2e2a <_exit>
...
void set_motor_direction_duty(uint8_t motor_id, int16_t direction_and_duty)
{
    ...
    uint8_t duty = (uint8_t) abs(direction_and_duty);
      ...
      e0:	ed 58       	subi	r30, 0x8D	; 141
      e2:	f1 45       	sbci	r31, 0x51	; 81
      e4:	a0 81       	ld	r26, Z
      e6:	fc 01       	movw	r30, r24
      e8:	e0 59       	subi	r30, 0x90	; 144
...
void diag_puts(const char *str)
{
	...
	while (*p != 0) {
     ...
     172:	80 91 04 08 	lds	r24, 0x0804	; 0x800804 <CSWTCH.12+0x7f5991>
     176:	85 ff       	sbrs	r24, 5
     178:	fc cf       	rjmp	.-8      	; 0x172 <diag_puts+0x8>
			// Sleep
		}
		USART0.TXDATAL = *p;
     17a:	90 93 02 08 	sts	0x0802, r25	; 0x800802 <CSWTCH.12+0x7f598f>
...
static void uninit_everything()
{
    USART0.CTRLB = 0; //disable rx and tx
     182:	10 92 06 08 	sts	0x0806, r1	; 0x800806 <CSWTCH.12+0x7f5993>
    // Set all ports as inputs.
    PORTA.DIR = 0 ;
     186:	10 92 00 04 	sts	0x0400, r1	; 0x800400 <CSWTCH.12+0x7f558d>
    PORTB.DIR = 0 ;
     18a:	10 92 20 04 	sts	0x0420, r1	; 0x800420 <CSWTCH.12+0x7f55ad>
    PORTC.DIR = 0 ;
     18e:	10 92 40 04 	sts	0x0440, r1	; 0x800440 <CSWTCH.12+0x7f55cd>
    // Disable all the timers, so that nothing can keep
    // going automatically.
    TCA0.SPLIT.CTRLA = 0;
     192:	10 92 00 0a 	sts	0x0A00, r1	; 0x800a00 <CSWTCH.12+0x7f5b8d>
    TCB0.CTRLA = 0;
     196:	10 92 40 0a 	sts	0x0A40, r1	; 0x800a40 <CSWTCH.12+0x7f5bcd>
    TCD0.CTRLA = 0;
     19a:	10 92 80 0a 	sts	0x0A80, r1	; 0x800a80 <CSWTCH.12+0x7f5c0d>
     19e:	08 95       	ret
...
void trigger_reset()
{
    ...
    while (1) {
     ...
     1d8:	90 93 41 00 	sts	0x0041, r25	; 0x800041 <CSWTCH.12+0x7f51ce>
...
void nvconfig_save()
{
    ...
    eeprom_update_block((void *) &nvdata, eeprom_addr, sizeof(nvdata));
     ...
     28c:	0e 94 51 11 	call	0x22a2	; 0x22a2 <eeprom_update_block>
}
...
000002b0 <diag_print>:
    ...
    void diag_print(const char * fmt, ...)
    {
     ...
     2ce:	0e 94 27 14 	call	0x284e	; 0x284e <vsnprintf>
        va_end(ap);
...
00000378 <diag_println>:
    ...
    void diag_println(const char * fmt, ...)
    {
     ...
     396:	0e 94 27 14 	call	0x284e	; 0x284e <vsnprintf>
        va_end(ap);
        buf[DIAG_BUFSIZE -1] = '\0'; // ensure null terminated
...
static void init_bind_mode()
{
    diag_println("initialising bind mode");
     40a:	8a ee       	ldi	r24, 0xEA	; 234
     40c:	9e ea       	ldi	r25, 0xAE	; 174
     40e:	9f 93       	push	r25
     410:	8f 93       	push	r24
...
static void init_gio1_pin()
{
    ...
    uint8_t in0 = (GIO1_PORT->IN & GIO1_bm);
     56c:	00 91 08 04 	lds	r16, 0x0408	; 0x800408 <CSWTCH.12+0x7f5595>
    ...
    uint8_t in1 = (GIO1_PORT->IN & GIO1_bm);
     57a:	10 91 08 04 	lds	r17, 0x0408	; 0x800408 <CSWTCH.12+0x7f5595>
    ...
    if (memcmp(id_readback, radio_id,4) != 0) {
     ...
     746:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
...
000007b8 <init_interrupts>:
    ...
    PORTA.PIN2CTRL = PORT_ISC_FALLING_gc;    
     7ec:	80 93 12 04 	sts	0x0412, r24	; 0x800412 <CSWTCH.12+0x7f559f>
     7f0:	0f 90       	pop	r0
     7f2:	0f 90       	pop	r0
     7f4:	08 95       	ret
...
ISR(PORTA_PORT_vect)
{
    ...
    uint8_t bit = PORTA.IN & GIO1_bm;
     82e:	80 91 08 04 	lds	r24, 0x0408	; 0x800408 <CSWTCH.12+0x7f5595>
    if (! bit) {
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     840:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     856:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
    uint8_t state = radio_state.state;
    bool ok = false;
    bool do_hop = false;
    if ((modeflags & errflags)) {
    ...
    if ((modeflags & errflags)) {
     ...
     880:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
    ...
    if (memcmp(buf+1, radio_state.tx_id, 4) != 0) {
     ...
     8a2:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     8b2:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
...
static void reset_timeout()
{
    ...
    // expires again
    TCB0.CNT = 0;
     8e0:	10 92 4a 0a 	sts	0x0A4A, r1	; 0x800a4a <CSWTCH.12+0x7f5bd7>
     8e4:	10 92 4b 0a 	sts	0x0A4B, r1	; 0x800a4b <CSWTCH.12+0x7f5bd8>
    TCB0.INTFLAGS |= TCB_CAPT_bm;
     8e8:	80 91 46 0a 	lds	r24, 0x0A46	; 0x800a46 <CSWTCH.12+0x7f5bd3>
     8ec:	81 60       	ori	r24, 0x01	; 1
     8ee:	80 93 46 0a 	sts	0x0A46, r24	; 0x800a46 <CSWTCH.12+0x7f5bd3>
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     930:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     968:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
        } else {
            // Drop the packet contents, but still hop to next channel
        }
        radio_state.missed_packet_count = 0; // successive missed packets.
    ...
    PORTA.INTFLAGS = GIO1_bm;
     ...
     9a4:	80 93 09 04 	sts	0x0409, r24	; 0x800409 <CSWTCH.12+0x7f5596>
}
    ...
    if ((b9 == 2) && (memcmp(buf+5, radio_state.rx_id, 4) == 0)) {
     ...
     a42:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
...
ISR(TCB0_INT_vect)
{
    ...
    if (TCB0.INTFLAGS & TCB_CAPT_bm) {
     a72:	80 91 46 0a 	lds	r24, 0x0A46	; 0x800a46 <CSWTCH.12+0x7f5bd3>
     ...
     a7a:	80 91 46 0a 	lds	r24, 0x0A46	; 0x800a46 <CSWTCH.12+0x7f5bd3>
     a7e:	81 60       	ori	r24, 0x01	; 1
     a80:	80 93 46 0a 	sts	0x0A46, r24	; 0x800a46 <CSWTCH.12+0x7f5bd3>
...
static void maybe_diag_putc(char c)
{
    ...
    USART0.TXDATAL = c;
     ...
     ac4:	80 93 02 08 	sts	0x0802, r24	; 0x800802 <CSWTCH.12+0x7f598f>
            // it to come around again.
            hop_to_next_channel(0);
        }
        enable_rx();    
...
static void init_clock()
{
    ...
    1178:	80 93 61 00 	sts	0x0061, r24	; 0x800061 <CSWTCH.12+0x7f51ee>
...
static void init_serial()
{
    ...
    1188:	80 93 01 02 	sts	0x0201, r24	; 0x800201 <CSWTCH.12+0x7f538e>
    // Diagnostic uart output       
    // TxD pin PA1 is used for diag, should be an output
    // And set it initially high
    PORTA.OUTSET = 1 << 1;
    118c:	82 e0       	ldi	r24, 0x02	; 2
    118e:	80 93 05 04 	sts	0x0405, r24	; 0x800405 <CSWTCH.12+0x7f5592>
    PORTA.DIRSET = 1 << 1;
    1192:	80 93 01 04 	sts	0x0401, r24	; 0x800401 <CSWTCH.12+0x7f558e>
    ...
    119a:	80 93 08 08 	sts	0x0808, r24	; 0x800808 <CSWTCH.12+0x7f5995>
    119e:	90 93 09 08 	sts	0x0809, r25	; 0x800809 <CSWTCH.12+0x7f5996>
    USART0.CTRLB = 
    11a2:	80 ec       	ldi	r24, 0xC0	; 192
    11a4:	80 93 06 08 	sts	0x0806, r24	; 0x800806 <CSWTCH.12+0x7f5993>
int main(void)
{
    init_clock();
    init_serial();
...
static void watchdog_early_init()
{
    ...
    11b0:	80 91 40 00 	lds	r24, 0x0040	; 0x800040 <CSWTCH.12+0x7f51cd>
    ...
    11c2:	80 93 40 00 	sts	0x0040, r24	; 0x800040 <CSWTCH.12+0x7f51cd>
static void init_timer()
{
    ...
    11c8:	10 93 8c 0a 	sts	0x0A8C, r17	; 0x800a8c <CSWTCH.12+0x7f5c19>
...
void weapons_init() 
{
    ...
    11f0:	90 93 92 0a 	sts	0x0A92, r25	; 0x800a92 <CSWTCH.12+0x7f5c1f>
    // And disable TCD
    TCD0.CTRLA = 0;
    11f4:	10 92 80 0a 	sts	0x0A80, r1	; 0x800a80 <CSWTCH.12+0x7f5c0d>
    ...
    1206:	80 93 46 04 	sts	0x0446, r24	; 0x800446 <CSWTCH.12+0x7f55d3>
    PORTC.DIRSET = both;
    120a:	80 93 41 04 	sts	0x0441, r24	; 0x800441 <CSWTCH.12+0x7f55ce>
	#else
		//round up by default
		__ticks_dc = (uint32_t)(ceil(fabs(__tmp)));
	#endif
    ...
    121e:	f0 92 42 04 	sts	0x0442, r15	; 0x800442 <CSWTCH.12+0x7f55cf>
    PORTC.OUTSET = weapon2_bm;
    1222:	10 93 45 04 	sts	0x0445, r17	; 0x800445 <CSWTCH.12+0x7f55d2>
    ...
    122e:	00 91 48 04 	lds	r16, 0x0448	; 0x800448 <CSWTCH.12+0x7f55d5>
    PORTC.OUTCLR = weapon2_bm;
    1232:	10 93 46 04 	sts	0x0446, r17	; 0x800446 <CSWTCH.12+0x7f55d3>
    ...
    123e:	10 91 48 04 	lds	r17, 0x0448	; 0x800448 <CSWTCH.12+0x7f55d5>
    ...
    1280:	f0 92 41 04 	sts	0x0441, r15	; 0x800441 <CSWTCH.12+0x7f55ce>
    1284:	0f 90       	pop	r0
    1286:	0f 90       	pop	r0
    _PROTECTED_WRITE(TCD0.FAULTCTRL, 0);
    // And disable TCD
    ...
    128a:	80 93 41 04 	sts	0x0441, r24	; 0x800441 <CSWTCH.12+0x7f55ce>
    ...
    128e:	80 91 82 0a 	lds	r24, 0x0A82	; 0x800a82 <CSWTCH.12+0x7f5c0f>
    1292:	80 68       	ori	r24, 0x80	; 128
    1294:	80 93 82 0a 	sts	0x0A82, r24	; 0x800a82 <CSWTCH.12+0x7f5c0f>
    ...
    12a0:	20 93 92 0a 	sts	0x0A92, r18	; 0x800a92 <CSWTCH.12+0x7f5c1f>
    // Divider will be 64, 
    ...
    12a8:	80 93 aa 0a 	sts	0x0AAA, r24	; 0x800aaa <CSWTCH.12+0x7f5c37>
    12ac:	90 93 ab 0a 	sts	0x0AAB, r25	; 0x800aab <CSWTCH.12+0x7f5c38>
    TCD0.CMPBCLR = max_count; // reset time
    12b0:	80 93 ae 0a 	sts	0x0AAE, r24	; 0x800aae <CSWTCH.12+0x7f5c3b>
    12b4:	90 93 af 0a 	sts	0x0AAF, r25	; 0x800aaf <CSWTCH.12+0x7f5c3c>
    // To generate pulses, we reduce CMPASET to lower values, then
    // it creates a positive pulse 
    TCD0.CMPASET = max_count;
    12b8:	80 93 a8 0a 	sts	0x0AA8, r24	; 0x800aa8 <CSWTCH.12+0x7f5c35>
    12bc:	90 93 a9 0a 	sts	0x0AA9, r25	; 0x800aa9 <CSWTCH.12+0x7f5c36>
    TCD0.CMPBSET = max_count;
    12c0:	80 93 ac 0a 	sts	0x0AAC, r24	; 0x800aac <CSWTCH.12+0x7f5c39>
    12c4:	90 93 ad 0a 	sts	0x0AAD, r25	; 0x800aad <CSWTCH.12+0x7f5c3a>
    
    // Finally turn the thing on.
    TCD0.CTRLA = TCD_ENABLE_bm |
    12c8:	83 e7       	ldi	r24, 0x73	; 115
    12ca:	80 93 80 0a 	sts	0x0A80, r24	; 0x800a80 <CSWTCH.12+0x7f5c0d>
{
#ifdef ENABLE_DIAG
    ...
    12ce:	20 91 02 11 	lds	r18, 0x1102	; 0x801102 <CSWTCH.12+0x7f628f>
static void show_device_info()
{
    ...
    diag_println("device id=%02x %02x %02x",
        (int) SIGROW.DEVICEID0,
        (int) SIGROW.DEVICEID1,
    12d2:	90 91 01 11 	lds	r25, 0x1101	; 0x801101 <CSWTCH.12+0x7f628e>
...
static void show_device_info()
{
    ...
    diag_println("device id=%02x %02x %02x",
        (int) SIGROW.DEVICEID0,
    12d6:	80 91 00 11 	lds	r24, 0x1100	; 0x801100 <CSWTCH.12+0x7f628d>
 */
...
static void show_device_info()
{
    ...
    12e2:	1f 92       	push	r1
    12e4:	8f 93       	push	r24
    12e6:	8e ec       	ldi	r24, 0xCE	; 206
    12e8:	91 eb       	ldi	r25, 0xB1	; 177
    12ea:	9f 93       	push	r25
    12ec:	8f 93       	push	r24
    ...
    1348:	0e 94 18 14 	call	0x2830	; 0x2830 <strncpy>
    buf[10] = '\0';
    134c:	1b 86       	std	Y+11, r1	; 0x0b
    diag_println("serial number (ascii) is:%s", buf);
    134e:	1f 93       	push	r17
    1350:	0f 93       	push	r16
    1352:	87 ef       	ldi	r24, 0xF7	; 247
    1354:	91 eb       	ldi	r25, 0xB1	; 177
    1356:	9f 93       	push	r25
    1358:	8f 93       	push	r24
...
void spi_init() {
    ...
    140e:	80 93 26 04 	sts	0x0426, r24	; 0x800426 <CSWTCH.12+0x7f55b3>
	PORTB.OUTCLR = 1 << 1;
    1412:	52 e0       	ldi	r21, 0x02	; 2
    1414:	50 93 26 04 	sts	0x0426, r21	; 0x800426 <CSWTCH.12+0x7f55b3>
	PORTB.OUTCLR = 1 << 2;
    1418:	44 e0       	ldi	r20, 0x04	; 4
    141a:	40 93 26 04 	sts	0x0426, r20	; 0x800426 <CSWTCH.12+0x7f55b3>
	PORTA.OUTCLR = 1 << 3;
    141e:	38 e0       	ldi	r19, 0x08	; 8
    1420:	30 93 06 04 	sts	0x0406, r19	; 0x800406 <CSWTCH.12+0x7f5593>
	PORTA.OUTCLR = 1 << 4;
    1424:	20 e1       	ldi	r18, 0x10	; 16
    1426:	20 93 06 04 	sts	0x0406, r18	; 0x800406 <CSWTCH.12+0x7f5593>
	PORTA.OUTCLR = 1 << 5;
    142a:	90 e2       	ldi	r25, 0x20	; 32
    142c:	90 93 06 04 	sts	0x0406, r25	; 0x800406 <CSWTCH.12+0x7f5593>
	// set directions to out
	PORTB.DIRSET = 1 << 0;
    1430:	80 93 21 04 	sts	0x0421, r24	; 0x800421 <CSWTCH.12+0x7f55ae>
	PORTB.DIRSET = 1 << 1;
    1434:	50 93 21 04 	sts	0x0421, r21	; 0x800421 <CSWTCH.12+0x7f55ae>
	PORTB.DIRSET = 1 << 2;
    1438:	40 93 21 04 	sts	0x0421, r20	; 0x800421 <CSWTCH.12+0x7f55ae>
	PORTA.DIRSET = 1 << 3;
    143c:	30 93 01 04 	sts	0x0401, r19	; 0x800401 <CSWTCH.12+0x7f558e>
	PORTA.DIRSET = 1 << 4;
    1440:	20 93 01 04 	sts	0x0401, r18	; 0x800401 <CSWTCH.12+0x7f558e>
	PORTA.DIRSET = 1 << 5;
    1444:	90 93 01 04 	sts	0x0401, r25	; 0x800401 <CSWTCH.12+0x7f558e>
	//
    ...
    1448:	80 93 03 0a 	sts	0x0A03, r24	; 0x800a03 <CSWTCH.12+0x7f5b90>
	// Enable all comparators in split mode
	TCA0.SPLIT.CTRLB = 
    144c:	87 e7       	ldi	r24, 0x77	; 119
    144e:	80 93 01 0a 	sts	0x0A01, r24	; 0x800a01 <CSWTCH.12+0x7f5b8e>
    ...
    1454:	80 93 27 0a 	sts	0x0A27, r24	; 0x800a27 <CSWTCH.12+0x7f5bb4>
	TCA0.SPLIT.LPER = period_val;
    1458:	80 93 26 0a 	sts	0x0A26, r24	; 0x800a26 <CSWTCH.12+0x7f5bb3>
	// Set the halves to be "out of sync"
	TCA0.SPLIT.HCNT = period_val /2;
    145c:	84 e6       	ldi	r24, 0x64	; 100
    145e:	80 93 21 0a 	sts	0x0A21, r24	; 0x800a21 <CSWTCH.12+0x7f5bae>
	// Finally, turn the timer on.
    // Divide by 64, 3.333mhz / 64 =~ 52khz
    // 52khz / period_val =~ 260hz = PWM frequency.
	TCA0.SPLIT.CTRLA = 
    1462:	8b e0       	ldi	r24, 0x0B	; 11
    1464:	80 93 00 0a 	sts	0x0A00, r24	; 0x800a00 <CSWTCH.12+0x7f5b8d>
    weapons_init();
    show_device_info();
    // test_get_micros();
    spi_init();
...
void nvconfig_load()
{
    ...
    1476:	0e 94 4d 11 	call	0x229a	; 0x229a <eeprom_read_block>
...
static void vsense_hw_init()
{
    ...
    14c2:	80 93 a0 00 	sts	0x00A0, r24	; 0x8000a0 <CSWTCH.12+0x7f522d>
    // We use pin PC2 as analogue input (on attiny1617).
    // Disable the digital input.
    PORTC.PIN2CTRL &= ~PORT_ISC_gm;
    14c6:	80 91 52 04 	lds	r24, 0x0452	; 0x800452 <CSWTCH.12+0x7f55df>
    14ca:	88 7f       	andi	r24, 0xF8	; 248
    14cc:	80 93 52 04 	sts	0x0452, r24	; 0x800452 <CSWTCH.12+0x7f55df>
    PORTC.PIN2CTRL |= PORT_ISC_INPUT_DISABLE_gc;
    14d0:	80 91 52 04 	lds	r24, 0x0452	; 0x800452 <CSWTCH.12+0x7f55df>
    14d4:	84 60       	ori	r24, 0x04	; 4
    14d6:	80 93 52 04 	sts	0x0452, r24	; 0x800452 <CSWTCH.12+0x7f55df>
    // We use pin PB5 as analogue input on attiny817
    // disable its digital input.
    PORTB.PIN5CTRL &= ~PORT_ISC_gm;
    14da:	80 91 35 04 	lds	r24, 0x0435	; 0x800435 <CSWTCH.12+0x7f55c2>
    14de:	88 7f       	andi	r24, 0xF8	; 248
    14e0:	80 93 35 04 	sts	0x0435, r24	; 0x800435 <CSWTCH.12+0x7f55c2>
    PORTB.PIN5CTRL |= PORT_ISC_INPUT_DISABLE_gc;
    14e4:	80 91 35 04 	lds	r24, 0x0435	; 0x800435 <CSWTCH.12+0x7f55c2>
    14e8:	84 60       	ori	r24, 0x04	; 4
    14ea:	80 93 35 04 	sts	0x0435, r24	; 0x800435 <CSWTCH.12+0x7f55c2>
    ...
    14f0:	80 93 02 06 	sts	0x0602, r24	; 0x800602 <CSWTCH.12+0x7f578f>
               | ADC_REFSEL_INTREF_gc;  /* Internal reference */
    
    ADC0.CTRLA = ADC_ENABLE_bm          /* ADC Enable: enabled */
    14f4:	91 e0       	ldi	r25, 0x01	; 1
    14f6:	90 93 00 06 	sts	0x0600, r25	; 0x800600 <CSWTCH.12+0x7f578d>
               | ADC_RESSEL_10BIT_gc;   /* 10-bit mode */
    
    /* Select ADC channel */
    ADC0.MUXPOS  = ADC_MUXPOS_AIN8_gc; // ADC0.AIN8 == Pin PB5
    14fa:	88 e0       	ldi	r24, 0x08	; 8
    14fc:	80 93 06 06 	sts	0x0606, r24	; 0x800606 <CSWTCH.12+0x7f5793>
#endif

    /* Enable FreeRun mode */
    ADC_VSENSE.CTRLA |= ADC_FREERUN_bm;
    1500:	80 91 00 06 	lds	r24, 0x0600	; 0x800600 <CSWTCH.12+0x7f578d>
    1504:	82 60       	ori	r24, 0x02	; 2
    1506:	80 93 00 06 	sts	0x0600, r24	; 0x800600 <CSWTCH.12+0x7f578d>

    // Start the first conversion.
    ADC_VSENSE.COMMAND = ADC_STCONV_bm;    
    150a:	90 93 08 06 	sts	0x0608, r25	; 0x800608 <CSWTCH.12+0x7f5795>
#endif
}
...
static void watchdog_init()
{
    ...
    15fc:	90 93 00 01 	sts	0x0100, r25	; 0x800100 <CSWTCH.12+0x7f528d>
    1600:	0f 90       	pop	r0
    1602:	0f 90       	pop	r0
    ...
    1632:	99 c0       	rjmp	.+306    	; 0x1766 <main+0x602>
{
    ...
    1640:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
    ...
    16a0:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
    ...
    16dc:	0e 94 0b 14 	call	0x2816	; 0x2816 <memcmp>
    ...
    171a:	81 ed       	ldi	r24, 0xD1	; 209
    171c:	92 eb       	ldi	r25, 0xB2	; 178
    171e:	9f 93       	push	r25
    1720:	8f 93       	push	r24
...
static void handle_switches(uint32_t now)
{
    ...
    18a2:	1f 92       	push	r1
    18a4:	8f 93       	push	r24
    18a6:	2c ef       	ldi	r18, 0xFC	; 252
    18a8:	32 eb       	ldi	r19, 0xB2	; 178
    18aa:	3f 93       	push	r19
    18ac:	2f 93       	push	r18
    ...
    18d2:	0c 94 db 11 	jmp	0x23b6	; 0x23b6 <__tablejump2__>
...
void nvconfig_reset()
{
    ...
    192a:	0e 94 51 11 	call	0x22a2	; 0x22a2 <eeprom_update_block>
}
...
void trigger_reset()
{
    ...
    1936:	90 93 41 00 	sts	0x0041, r25	; 0x800041 <CSWTCH.12+0x7f51ce>
...
static void show_rpm_value(uint8_t count, uint8_t value)
{
    ...
    19d0:	0e 94 b9 11 	call	0x2372	; 0x2372 <__udivmodsi4>
    ...
    1a20:	0e 94 a5 11 	call	0x234a	; 0x234a <__divmodhi4>
    ...
    1a5a:	0e 94 a5 11 	call	0x234a	; 0x234a <__divmodhi4>
    ...
    1a90:	0e 94 a5 11 	call	0x234a	; 0x234a <__divmodhi4>
...
static int deadzone(int n, int deadzone)
{
    ...
    1ade:	0e 94 12 13 	call	0x2624	; 0x2624 <__floatsisf>
    ...
    1b10:	0e 94 12 13 	call	0x2624	; 0x2624 <__floatsisf>
    ...
    1b24:	0e 94 fb 11 	call	0x23f6	; 0x23f6 <__subsf3>
    1b28:	a7 01       	movw	r20, r14
    1b2a:	96 01       	movw	r18, r12
    1b2c:	0e 94 fc 11 	call	0x23f8	; 0x23f8 <__addsf3>
    1b30:	20 e0       	ldi	r18, 0x00	; 0
    1b32:	30 e0       	ldi	r19, 0x00	; 0
    1b34:	40 e4       	ldi	r20, 0x40	; 64
    1b36:	50 e4       	ldi	r21, 0x40	; 64
    1b38:	0e 94 68 12 	call	0x24d0	; 0x24d0 <__divsf3>
    1b3c:	0e 94 da 12 	call	0x25b4	; 0x25b4 <__fixsfsi>
    ...
    1b54:	0e 94 fc 11 	call	0x23f8	; 0x23f8 <__addsf3>
    1b58:	a7 01       	movw	r20, r14
    1b5a:	96 01       	movw	r18, r12
    1b5c:	0e 94 fc 11 	call	0x23f8	; 0x23f8 <__addsf3>
    1b60:	20 e0       	ldi	r18, 0x00	; 0
    1b62:	30 e0       	ldi	r19, 0x00	; 0
    1b64:	40 e4       	ldi	r20, 0x40	; 64
    1b66:	50 e4       	ldi	r21, 0x40	; 64
    1b68:	0e 94 68 12 	call	0x24d0	; 0x24d0 <__divsf3>
    1b6c:	0e 94 da 12 	call	0x25b4	; 0x25b4 <__fixsfsi>
    ...
    1b82:	0e 94 a5 11 	call	0x234a	; 0x234a <__divmodhi4>
    ...
    1be0:	31 f0       	breq	.+12     	; 0x1bee <main+0xa8a>
{
    ...
    *comp1 = DUTY_MAX;
    ...
    1be4:	80 93 2c 0a 	sts	0x0A2C, r24	; 0x800a2c <CSWTCH.12+0x7f5bb9>
    *comp2 = DUTY_MAX;
    1be8:	80 93 2a 0a 	sts	0x0A2A, r24	; 0x800a2a <CSWTCH.12+0x7f5bb7>
    ...
    1c08:	31 f0       	breq	.+12     	; 0x1c16 <main+0xab2>
{
    ...
    *comp1 = DUTY_MAX;
    ...
    1c0c:	80 93 2d 0a 	sts	0x0A2D, r24	; 0x800a2d <CSWTCH.12+0x7f5bba>
    *comp2 = DUTY_MAX;
    1c10:	80 93 2b 0a 	sts	0x0A2B, r24	; 0x800a2b <CSWTCH.12+0x7f5bb8>
...
void weapons_set(uint16_t pulse2, uint16_t pulse3)
{
    ...
    1c86:	e0 93 a8 0a 	sts	0x0AA8, r30	; 0x800aa8 <CSWTCH.12+0x7f5c35>
    1c8a:	f0 93 a9 0a 	sts	0x0AA9, r31	; 0x800aa9 <CSWTCH.12+0x7f5c36>
    ...
    1cae:	00 93 ac 0a 	sts	0x0AAC, r16	; 0x800aac <CSWTCH.12+0x7f5c39>
    1cb2:	10 93 ad 0a 	sts	0x0AAD, r17	; 0x800aad <CSWTCH.12+0x7f5c3a>
    // Sync domain
    TCD0.CTRLE = TCD_SYNCEOC_bm;
    1cb6:	81 e0       	ldi	r24, 0x01	; 1
    1cb8:	80 93 84 0a 	sts	0x0A84, r24	; 0x800a84 <CSWTCH.12+0x7f5c11>
        sticks[CHANNEL_INDEX_WEAPON2] = temp;
    }
    // Returns this structure;
    sticks_result_t result;
...
static void prepare_telemetry(bool is_config_mode, uint8_t rpm_value)
{
    ...
    1d90:	0e 94 91 11 	call	0x2322	; 0x2322 <__udivmodhi4>
...
void weapons_all_off()
{
    ...
    1ed0:	40 93 a8 0a 	sts	0x0AA8, r20	; 0x800aa8 <CSWTCH.12+0x7f5c35>
    1ed4:	50 93 a9 0a 	sts	0x0AA9, r21	; 0x800aa9 <CSWTCH.12+0x7f5c36>
    TCD0.CMPBSET = max_count;    
    1ed8:	40 93 ac 0a 	sts	0x0AAC, r20	; 0x800aac <CSWTCH.12+0x7f5c39>
    1edc:	50 93 ad 0a 	sts	0x0AAD, r21	; 0x800aad <CSWTCH.12+0x7f5c3a>
    // Sync domain
    TCD0.CTRLE = TCD_SYNCEOC_bm;
    1ee0:	81 e0       	ldi	r24, 0x01	; 1
    1ee2:	80 93 84 0a 	sts	0x0A84, r24	; 0x800a84 <CSWTCH.12+0x7f5c11>
// something.
    ...
    202a:	78 94       	sei
{
    ...
    2052:	e0 c0       	rjmp	.+448    	; 0x2214 <main+0x10b0>
    {
        // Check if ready.
        if (ADC_VSENSE.INTFLAGS & ADC_RESRDY_bm)
    2054:	80 91 0b 06 	lds	r24, 0x060B	; 0x80060b <CSWTCH.12+0x7f5798>
    2058:	80 ff       	sbrs	r24, 0
    205a:	d4 c0       	rjmp	.+424    	; 0x2204 <main+0x10a0>
        {
            uint16_t val = ADC_VSENSE.RES; // 0..1023
    205c:	20 91 10 06 	lds	r18, 0x0610	; 0x800610 <CSWTCH.12+0x7f579d>
    2060:	30 91 11 06 	lds	r19, 0x0611	; 0x800611 <CSWTCH.12+0x7f579e>
    ...
    2068:	0e 94 e1 11 	call	0x23c2	; 0x23c2 <__umulhisi3>
    206c:	2f ef       	ldi	r18, 0xFF	; 255
    206e:	33 e0       	ldi	r19, 0x03	; 3
    2070:	40 e0       	ldi	r20, 0x00	; 0
    2072:	50 e0       	ldi	r21, 0x00	; 0
    2074:	0e 94 b9 11 	call	0x2372	; 0x2372 <__udivmodsi4>
    2078:	ab e2       	ldi	r26, 0x2B	; 43
    207a:	b0 e0       	ldi	r27, 0x00	; 0
    207c:	0e 94 f0 11 	call	0x23e0	; 0x23e0 <__muluhisi3>
    2080:	2a e0       	ldi	r18, 0x0A	; 10
    2082:	30 e0       	ldi	r19, 0x00	; 0
    2084:	40 e0       	ldi	r20, 0x00	; 0
    2086:	50 e0       	ldi	r21, 0x00	; 0
    2088:	0e 94 b9 11 	call	0x2372	; 0x2372 <__udivmodsi4>
    ...
    209e:	50 c0       	rjmp	.+160    	; 0x2140 <main+0xfdc>
                diag_println("vbat=%04ld mv", vsense_mv);
    20a0:	ff 92       	push	r15
    20a2:	ef 92       	push	r14
    20a4:	df 92       	push	r13
    20a6:	cf 92       	push	r12
    20a8:	89 e3       	ldi	r24, 0x39	; 57
    ...
    20fe:	04 c0       	rjmp	.+8      	; 0x2108 <main+0xfa4>
                    // 3s or 4s lipo
    ...
    2100:	10 92 0d 38 	sts	0x380D, r1	; 0x80380d <vsense_state>
    2104:	10 92 0e 38 	sts	0x380E, r1	; 0x80380e <vsense_state+0x1>
                }
                if (vsense_state.cells_count > 0) {
    2108:	80 91 0d 38 	lds	r24, 0x380D	; 0x80380d <vsense_state>
    210c:	90 91 0e 38 	lds	r25, 0x380E	; 0x80380e <vsense_state+0x1>
    2110:	18 16       	cp	r1, r24
    2112:	19 06       	cpc	r1, r25
    2114:	6c f4       	brge	.+26     	; 0x2130 <main+0xfcc>
                    diag_println("Detected %d battery cells", vsense_state.cells_count); 
    2116:	9f 93       	push	r25
    2118:	8f 93       	push	r24
    211a:	87 e4       	ldi	r24, 0x47	; 71
    211c:	93 eb       	ldi	r25, 0xB3	; 179
    211e:	9f 93       	push	r25
    2120:	8f 93       	push	r24
    2122:	0e 94 bc 01 	call	0x378	; 0x378 <diag_println>
    2126:	0f 90       	pop	r0
    2128:	0f 90       	pop	r0
    212a:	0f 90       	pop	r0
    212c:	0f 90       	pop	r0
    212e:	08 c0       	rjmp	.+16     	; 0x2140 <main+0xfdc>
                } else {
                    diag_println("Battery voltage out of range, bench test?");
    2130:	81 e6       	ldi	r24, 0x61	; 97
    2132:	93 eb       	ldi	r25, 0xB3	; 179
    2134:	9f 93       	push	r25
    2136:	8f 93       	push	r24
    2138:	0e 94 bc 01 	call	0x378	; 0x378 <diag_println>
    213c:	0f 90       	pop	r0
    213e:	0f 90       	pop	r0
                }
            }
            vsense_state.voltage_mv = vsense_mv;
    2140:	c0 92 0f 38 	sts	0x380F, r12	; 0x80380f <vsense_state+0x2>
    2144:	d0 92 10 38 	sts	0x3810, r13	; 0x803810 <vsense_state+0x3>
            if (vsense_state.cells_count > 0) 
    2148:	20 91 0d 38 	lds	r18, 0x380D	; 0x80380d <vsense_state>
    214c:	30 91 0e 38 	lds	r19, 0x380E	; 0x80380e <vsense_state+0x1>
    2150:	12 16       	cp	r1, r18
    2152:	13 06       	cpc	r1, r19
    2154:	0c f0       	brlt	.+2      	; 0x2158 <main+0xff4>
    2156:	56 c0       	rjmp	.+172    	; 0x2204 <main+0x10a0>
            {
                uint16_t critical_voltage = vsense_state.cells_count * CRITICAL_VOLTAGE_PER_CELL;
                if (vsense_mv < critical_voltage) {
    2158:	40 ef       	ldi	r20, 0xF0	; 240
    215a:	5a e0       	ldi	r21, 0x0A	; 10
    215c:	24 9f       	mul	r18, r20
    215e:	c0 01       	movw	r24, r0
    2160:	25 9f       	mul	r18, r21
    2162:	90 0d       	add	r25, r0
    2164:	34 9f       	mul	r19, r20
    2166:	90 0d       	add	r25, r0
    ...
    217a:	08 f0       	brcs	.+2      	; 0x217e <main+0x101a>
    217c:	41 c0       	rjmp	.+130    	; 0x2200 <main+0x109c>
                    vsense_state.critical_count += 1;
    217e:	80 91 11 38 	lds	r24, 0x3811	; 0x803811 <vsense_state+0x4>
    2182:	8f 5f       	subi	r24, 0xFF	; 255
    2184:	80 93 11 38 	sts	0x3811, r24	; 0x803811 <vsense_state+0x4>
                    diag_println("Warning: VERY LOW BATTERY");
    2188:	8b e8       	ldi	r24, 0x8B	; 139
    218a:	93 eb       	ldi	r25, 0xB3	; 179
    218c:	9f 93       	push	r25
    218e:	8f 93       	push	r24
    2190:	0e 94 bc 01 	call	0x378	; 0x378 <diag_println>
                    if (vsense_state.critical_count > CRITICAL_COUNT) {
    2194:	0f 90       	pop	r0
    2196:	0f 90       	pop	r0
    2198:	80 91 11 38 	lds	r24, 0x3811	; 0x803811 <vsense_state+0x4>
    219c:	8d 30       	cpi	r24, 0x0D	; 13
    219e:	90 f1       	brcs	.+100    	; 0x2204 <main+0x10a0>
...
void shutdown_system()
{
    ...
    21a4:	93 eb       	ldi	r25, 0xB3	; 179
    21a6:	9f 93       	push	r25
    21a8:	8f 93       	push	r24
    21aa:	0e 94 bc 01 	call	0x378	; 0x378 <diag_println>
    diag_puts("\r\n");
    21ae:	81 e6       	ldi	r24, 0x61	; 97
    21b0:	91 eb       	ldi	r25, 0xB1	; 177
    21b2:	0e 94 b5 00 	call	0x16a	; 0x16a <diag_puts>
void radio_shutdown()
{
    ...
    21b8:	10 92 45 0a 	sts	0x0A45, r1	; 0x800a45 <CSWTCH.12+0x7f5bd2>
    PORTA.PIN2CTRL = 0; // Turn off irq from there.
    21bc:	10 92 12 04 	sts	0x0412, r1	; 0x800412 <CSWTCH.12+0x7f559f>
    TCB0.CTRLA = 0; // Shut down timer
    21c0:	10 92 40 0a 	sts	0x0A40, r1	; 0x800a40 <CSWTCH.12+0x7f5bcd>
    spi_strobe(STROBE_STANDBY);
    21c4:	80 ea       	ldi	r24, 0xA0	; 160
    21c6:	0e 94 d5 06 	call	0xdaa	; 0xdaa <spi_strobe>
	#else
		//round up by default
		__ticks_dc = (uint32_t)(ceil(fabs(__tmp)));
	#endif
	...
	__builtin_avr_delay_cycles(__ticks_dc);
    21ca:	87 ea       	ldi	r24, 0xA7	; 167
    21cc:	91 e6       	ldi	r25, 0x61	; 97
    21ce:	01 97       	sbiw	r24, 0x01	; 1
    21d0:	f1 f7       	brne	.-4      	; 0x21ce <main+0x106a>
    21d2:	00 c0       	rjmp	.+0      	; 0x21d4 <main+0x1070>
    21d4:	00 00       	nop
    _delay_ms(10);
    // Get the radio into low power mode.
    spi_strobe(STROBE_SLEEP);
    21d6:	80 e8       	ldi	r24, 0x80	; 128
    21d8:	0e 94 d5 06 	call	0xdaa	; 0xdaa <spi_strobe>
}
...
static void watchdog_stop()
{
    ...
    21e0:	84 bf       	out	0x34, r24	; 52
    21e2:	90 93 00 01 	sts	0x0100, r25	; 0x800100 <CSWTCH.12+0x7f528d>
    cli();
    diag_println("### Shutting down ###");
    diag_puts("\r\n");
    radio_shutdown();
    ...
    21e8:	93 eb       	ldi	r25, 0xB3	; 179
    21ea:	9f 93       	push	r25
    21ec:	8f 93       	push	r24
    21ee:	0e 94 bc 01 	call	0x378	; 0x378 <diag_println>
    // Set all ports to inputs.
    // This saves a little current powering the leds etc.
    // Also, if the motors are running, they will stop.
    uninit_everything();
    21f2:	0e 94 c1 00 	call	0x182	; 0x182 <uninit_everything>
    21f6:	0f 90       	pop	r0
    21f8:	0f 90       	pop	r0
    21fa:	0f 90       	pop	r0
    21fc:	0f 90       	pop	r0
    21fe:	ff cf       	rjmp	.-2      	; 0x21fe <main+0x109a>
                        shutdown_system();
                    }
                } else {
                    // Battery seems to have recovered, zero the count.
                    vsense_state.critical_count = 0;
    2200:	10 92 11 38 	sts	0x3811, r1	; 0x803811 <vsense_state+0x4>
                }
            }
        }
        last_vsense_tickcount = now;
    2204:	80 92 12 38 	sts	0x3812, r8	; 0x803812 <last_vsense_tickcount>
    2208:	90 92 13 38 	sts	0x3813, r9	; 0x803813 <last_vsense_tickcount+0x1>
    220c:	a0 92 14 38 	sts	0x3814, r10	; 0x803814 <last_vsense_tickcount+0x2>
    2210:	b0 92 15 38 	sts	0x3815, r11	; 0x803815 <last_vsense_tickcount+0x3>
{
}
...
{
    if (! has_signal) {
    2214:	80 91 22 38 	lds	r24, 0x3822	; 0x803822 <has_signal>
    2218:	81 11       	cpse	r24, r1
    221a:	36 c0       	rjmp	.+108    	; 0x2288 <main+0x1124>
        if (! configuration_mode) {
    221c:	80 91 21 38 	lds	r24, 0x3821	; 0x803821 <configuration_mode>
    2220:	81 11       	cpse	r24, r1
    2222:	32 c0       	rjmp	.+100    	; 0x2288 <main+0x1124>
}
...
uint32_t get_tickcount()
{
    ...
    2224:	f8 94       	cli
    tc = master_state.tickcount;
    2226:	80 91 73 38 	lds	r24, 0x3873	; 0x803873 <master_state>
    222a:	90 91 74 38 	lds	r25, 0x3874	; 0x803874 <master_state+0x1>
    222e:	a0 91 75 38 	lds	r26, 0x3875	; 0x803875 <master_state+0x2>
    2232:	b0 91 76 38 	lds	r27, 0x3876	; 0x803876 <master_state+0x3>
    sei(); // enable irq
    2236:	78 94       	sei
            uint32_t now = get_tickcount();
            if ((now - last_signal_time) > 500)
    2238:	40 91 1d 38 	lds	r20, 0x381D	; 0x80381d <last_signal_time>
    223c:	50 91 1e 38 	lds	r21, 0x381E	; 0x80381e <last_signal_time+0x1>
    2240:	60 91 1f 38 	lds	r22, 0x381F	; 0x80381f <last_signal_time+0x2>
    2244:	70 91 20 38 	lds	r23, 0x3820	; 0x803820 <last_signal_time+0x3>
    2248:	84 1b       	sub	r24, r20
    224a:	95 0b       	sbc	r25, r21
    224c:	a6 0b       	sbc	r26, r22
    224e:	b7 0b       	sbc	r27, r23
    2250:	85 3f       	cpi	r24, 0xF5	; 245
    2252:	91 40       	sbci	r25, 0x01	; 1
    2254:	a1 05       	cpc	r26, r1
    2256:	b1 05       	cpc	r27, r1
    2258:	b8 f0       	brcs	.+46     	; 0x2288 <main+0x1124>
            {
                diag_puts("Entering configuration mode");
    225a:	8a ed       	ldi	r24, 0xDA	; 218
    225c:	93 eb       	ldi	r25, 0xB3	; 179
    225e:	0e 94 b5 00 	call	0x16a	; 0x16a <diag_puts>
                configuration_mode = true;
    2262:	81 e0       	ldi	r24, 0x01	; 1
    2264:	80 93 21 38 	sts	0x3821, r24	; 0x803821 <configuration_mode>
                throttle_min = 2000;
    2268:	80 ed       	ldi	r24, 0xD0	; 208
    226a:	97 e0       	ldi	r25, 0x07	; 7
    226c:	80 93 1b 38 	sts	0x381B, r24	; 0x80381b <throttle_min>
    2270:	90 93 1c 38 	sts	0x381C, r25	; 0x80381c <throttle_min+0x1>
                throttle_max = 0;
    2274:	10 92 19 38 	sts	0x3819, r1	; 0x803819 <throttle_max>
    2278:	10 92 1a 38 	sts	0x381A, r1	; 0x80381a <throttle_max+0x1>
                config_switch_last = false;
    227c:	10 92 18 38 	sts	0x3818, r1	; 0x803818 <config_switch_last>
                config_switch_count = 0;
    2280:	10 92 17 38 	sts	0x3817, r1	; 0x803817 <config_switch_count>
                config_rpm_value = 0;
    2284:	10 92 16 38 	sts	0x3816, r1	; 0x803816 <config_rpm_value>
...
static void watchdog_loop()
{
    ...
    2288:	80 91 77 38 	lds	r24, 0x3877	; 0x803877 <master_state+0x4>
    228c:	88 23       	and	r24, r24
    228e:	09 f4       	brne	.+2      	; 0x2292 <main+0x112e>
    2290:	be c9       	rjmp	.-3204   	; 0x160e <main+0x4aa>
        wdt_reset();
    2292:	a8 95       	wdr
        master_state.radio_interrupt_ok = 0;
    2294:	10 92 77 38 	sts	0x3877, r1	; 0x803877 <master_state+0x4>
    2298:	ba c9       	rjmp	.-3212   	; 0x160e <main+0x4aa>

0000229a <eeprom_read_block>:
    229a:	60 50       	subi	r22, 0x00	; 0
    229c:	7c 4e       	sbci	r23, 0xEC	; 236
    229e:	0c 94 88 11 	jmp	0x2310	; 0x2310 <memcpy>
...
000022c4 <eeprom_update_r18>:
    22c4:	0e 94 84 11 	call	0x2308	; 0x2308 <eeprom_mapen>
    22c8:	00 80       	ld	r0, Z
...
000022da <eeprom_write_r18>:
    ...
    22ee:	2c 93       	st	X, r18
    22f0:	3d e9       	ldi	r19, 0x9D	; 157
    22f2:	34 bf       	out	0x34, r19	; 52
...
00002300 <eeprom_read_byte>:
    2300:	03 d0       	rcall	.+6      	; 0x2308 <eeprom_mapen>
    2302:	80 81       	ld	r24, Z
    2304:	99 27       	eor	r25, r25
    2306:	08 95       	ret

00002308 <eeprom_mapen>:
    2308:	fc 01       	movw	r30, r24
    230a:	e0 50       	subi	r30, 0x00	; 0
    230c:	fc 4e       	sbci	r31, 0xEC	; 236
    230e:	08 95       	ret

00002310 <memcpy>:
    2310:	fb 01       	movw	r30, r22
    2312:	dc 01       	movw	r26, r24
    2314:	02 c0       	rjmp	.+4      	; 0x231a <memcpy+0xa>
    2316:	01 90       	ld	r0, Z+
    2318:	0d 92       	st	X+, r0
    231a:	41 50       	subi	r20, 0x01	; 1
    231c:	50 40       	sbci	r21, 0x00	; 0
    231e:	d8 f7       	brcc	.-10     	; 0x2316 <memcpy+0x6>
    2320:	08 95       	ret
...
0000234a <__divmodhi4>:
    234a:	97 fb       	bst	r25, 7
    234c:	07 2e       	mov	r0, r23
    234e:	16 f4       	brtc	.+4      	; 0x2354 <__divmodhi4+0xa>
    2350:	00 94       	com	r0
    2352:	07 d0       	rcall	.+14     	; 0x2362 <__divmodhi4_neg1>
    2354:	77 fd       	sbrc	r23, 7
    2356:	09 d0       	rcall	.+18     	; 0x236a <__divmodhi4_neg2>
    2358:	0e 94 91 11 	call	0x2322	; 0x2322 <__udivmodhi4>
    235c:	07 fc       	sbrc	r0, 7
    235e:	05 d0       	rcall	.+10     	; 0x236a <__divmodhi4_neg2>
    2360:	3e f4       	brtc	.+14     	; 0x2370 <__divmodhi4_exit>

00002362 <__divmodhi4_neg1>:
    2362:	90 95       	com	r25
    2364:	81 95       	neg	r24
    2366:	9f 4f       	sbci	r25, 0xFF	; 255
    2368:	08 95       	ret

0000236a <__divmodhi4_neg2>:
    236a:	70 95       	com	r23
    236c:	61 95       	neg	r22
    236e:	7f 4f       	sbci	r23, 0xFF	; 255

00002370 <__divmodhi4_exit>:
    2370:	08 95       	ret
...
000023e0 <__muluhisi3>:
    23e0:	0e 94 e1 11 	call	0x23c2	; 0x23c2 <__umulhisi3>
    23e4:	a5 9f       	mul	r26, r21
    23e6:	90 0d       	add	r25, r0
    23e8:	b4 9f       	mul	r27, r20
    23ea:	90 0d       	add	r25, r0
    23ec:	a4 9f       	mul	r26, r20
    23ee:	80 0d       	add	r24, r0
...
000023f8 <__addsf3>:
    ...
    2400:	0c 94 64 13 	jmp	0x26c8	; 0x26c8 <__fp_round>
    2404:	0e 94 56 13 	call	0x26ac	; 0x26ac <__fp_pscA>
    2408:	38 f0       	brcs	.+14     	; 0x2418 <__addsf3+0x20>
    240a:	0e 94 5d 13 	call	0x26ba	; 0x26ba <__fp_pscB>
    ...
    2418:	0c 94 53 13 	jmp	0x26a6	; 0x26a6 <__fp_nan>
    241c:	0e f4       	brtc	.+2      	; 0x2420 <__addsf3+0x28>
    241e:	e0 95       	com	r30
    2420:	e7 fb       	bst	r30, 7
    2422:	0c 94 4d 13 	jmp	0x269a	; 0x269a <__fp_inf>

00002426 <__addsf3x>:
    2426:	e9 2f       	mov	r30, r25
    2428:	0e 94 75 13 	call	0x26ea	; 0x26ea <__fp_split3>
    ...
    243e:	0c 94 97 13 	jmp	0x272e	; 0x272e <__fp_zero>
...
000024d0 <__divsf3>:
    ...
    24d4:	0c 94 64 13 	jmp	0x26c8	; 0x26c8 <__fp_round>
    24d8:	0e 94 5d 13 	call	0x26ba	; 0x26ba <__fp_pscB>
    24dc:	58 f0       	brcs	.+22     	; 0x24f4 <__divsf3+0x24>
    24de:	0e 94 56 13 	call	0x26ac	; 0x26ac <__fp_pscA>
    ...
    24ea:	0c 94 4d 13 	jmp	0x269a	; 0x269a <__fp_inf>
    24ee:	51 11       	cpse	r21, r1
    24f0:	0c 94 98 13 	jmp	0x2730	; 0x2730 <__fp_szero>
    24f4:	0c 94 53 13 	jmp	0x26a6	; 0x26a6 <__fp_nan>

000024f8 <__divsf3x>:
    24f8:	0e 94 75 13 	call	0x26ea	; 0x26ea <__fp_split3>
...
000024fe <__divsf3_pse>:
    ...
    2566:	0c 94 4d 13 	jmp	0x269a	; 0x269a <__fp_inf>
    256a:	0c 94 98 13 	jmp	0x2730	; 0x2730 <__fp_szero>
...
000025b4 <__fixsfsi>:
    25b4:	0e 94 e1 12 	call	0x25c2	; 0x25c2 <__fixunssfsi>
    25b8:	68 94       	set
    25ba:	b1 11       	cpse	r27, r1
    25bc:	0c 94 98 13 	jmp	0x2730	; 0x2730 <__fp_szero>
    25c0:	08 95       	ret

000025c2 <__fixunssfsi>:
    25c2:	0e 94 7d 13 	call	0x26fa	; 0x26fa <__fp_splitA>
    25c6:	88 f0       	brcs	.+34     	; 0x25ea <__fixunssfsi+0x28>
    25c8:	9f 57       	subi	r25, 0x7F	; 127
    25ca:	98 f0       	brcs	.+38     	; 0x25f2 <__fixunssfsi+0x30>
    25cc:	b9 2f       	mov	r27, r25
    25ce:	99 27       	eor	r25, r25
    25d0:	b7 51       	subi	r27, 0x17	; 23
    25d2:	b0 f0       	brcs	.+44     	; 0x2600 <__fixunssfsi+0x3e>
    25d4:	e1 f0       	breq	.+56     	; 0x260e <__fixunssfsi+0x4c>
    25d6:	66 0f       	add	r22, r22
    25d8:	77 1f       	adc	r23, r23
    25da:	88 1f       	adc	r24, r24
    25dc:	99 1f       	adc	r25, r25
    25de:	1a f0       	brmi	.+6      	; 0x25e6 <__fixunssfsi+0x24>
    25e0:	ba 95       	dec	r27
    25e2:	c9 f7       	brne	.-14     	; 0x25d6 <__fixunssfsi+0x14>
    25e4:	14 c0       	rjmp	.+40     	; 0x260e <__fixunssfsi+0x4c>
    25e6:	b1 30       	cpi	r27, 0x01	; 1
    25e8:	91 f0       	breq	.+36     	; 0x260e <__fixunssfsi+0x4c>
    25ea:	0e 94 97 13 	call	0x272e	; 0x272e <__fp_zero>
    25ee:	b1 e0       	ldi	r27, 0x01	; 1
    25f0:	08 95       	ret
    25f2:	0c 94 97 13 	jmp	0x272e	; 0x272e <__fp_zero>
    25f6:	67 2f       	mov	r22, r23
    25f8:	78 2f       	mov	r23, r24
    25fa:	88 27       	eor	r24, r24
    25fc:	b8 5f       	subi	r27, 0xF8	; 248
    25fe:	39 f0       	breq	.+14     	; 0x260e <__fixunssfsi+0x4c>
    2600:	b9 3f       	cpi	r27, 0xF9	; 249
    2602:	cc f3       	brlt	.-14     	; 0x25f6 <__fixunssfsi+0x34>
    2604:	86 95       	lsr	r24
    2606:	77 95       	ror	r23
    2608:	67 95       	ror	r22
    260a:	b3 95       	inc	r27
    260c:	d9 f7       	brne	.-10     	; 0x2604 <__fixunssfsi+0x42>
    260e:	3e f4       	brtc	.+14     	; 0x261e <__fixunssfsi+0x5c>
    2610:	90 95       	com	r25
    2612:	80 95       	com	r24
    2614:	70 95       	com	r23
    2616:	61 95       	neg	r22
...
00002620 <__floatunsisf>:
    2620:	e8 94       	clt
    2622:	09 c0       	rjmp	.+18     	; 0x2636 <__floatsisf+0x12>

00002624 <__floatsisf>:
    2624:	97 fb       	bst	r25, 7
    2626:	3e f4       	brtc	.+14     	; 0x2636 <__floatsisf+0x12>
    2628:	90 95       	com	r25
    262a:	80 95       	com	r24
    262c:	70 95       	com	r23
    262e:	61 95       	neg	r22
    ...
    2638:	a9 f0       	breq	.+42     	; 0x2664 <__floatsisf+0x40>
    263a:	f9 2f       	mov	r31, r25
    263c:	96 e9       	ldi	r25, 0x96	; 150
    ...
    2648:	67 95       	ror	r22
    264a:	b7 95       	ror	r27
    264c:	f1 11       	cpse	r31, r1
    264e:	f8 cf       	rjmp	.-16     	; 0x2640 <__floatsisf+0x1c>
    2650:	fa f4       	brpl	.+62     	; 0x2690 <__floatsisf+0x6c>
    2652:	bb 0f       	add	r27, r27
    2654:	11 f4       	brne	.+4      	; 0x265a <__floatsisf+0x36>
    2656:	60 ff       	sbrs	r22, 0
    2658:	1b c0       	rjmp	.+54     	; 0x2690 <__floatsisf+0x6c>
    265a:	6f 5f       	subi	r22, 0xFF	; 255
    265c:	7f 4f       	sbci	r23, 0xFF	; 255
    265e:	8f 4f       	sbci	r24, 0xFF	; 255
    2660:	9f 4f       	sbci	r25, 0xFF	; 255
    2662:	16 c0       	rjmp	.+44     	; 0x2690 <__floatsisf+0x6c>
    2664:	88 23       	and	r24, r24
    2666:	11 f0       	breq	.+4      	; 0x266c <__floatsisf+0x48>
    2668:	96 e9       	ldi	r25, 0x96	; 150
    266a:	11 c0       	rjmp	.+34     	; 0x268e <__floatsisf+0x6a>
    266c:	77 23       	and	r23, r23
    266e:	21 f0       	breq	.+8      	; 0x2678 <__floatsisf+0x54>
    2670:	9e e8       	ldi	r25, 0x8E	; 142
    2672:	87 2f       	mov	r24, r23
    2674:	76 2f       	mov	r23, r22
    2676:	05 c0       	rjmp	.+10     	; 0x2682 <__floatsisf+0x5e>
    2678:	66 23       	and	r22, r22
    267a:	71 f0       	breq	.+28     	; 0x2698 <__floatsisf+0x74>
    267c:	96 e8       	ldi	r25, 0x86	; 134
    267e:	86 2f       	mov	r24, r22
    2680:	70 e0       	ldi	r23, 0x00	; 0
    2682:	60 e0       	ldi	r22, 0x00	; 0
    2684:	2a f0       	brmi	.+10     	; 0x2690 <__floatsisf+0x6c>
    2686:	9a 95       	dec	r25
    2688:	66 0f       	add	r22, r22
    268a:	77 1f       	adc	r23, r23
    268c:	88 1f       	adc	r24, r24
    268e:	da f7       	brpl	.-10     	; 0x2686 <__floatsisf+0x62>
...
0000269a <__fp_inf>:
    ...
    269c:	9f 67       	ori	r25, 0x7F	; 127
    269e:	80 e8       	ldi	r24, 0x80	; 128
...
000026ba <__fp_pscB>:
    ...
    26c4:	05 06       	cpc	r0, r21
    26c6:	08 95       	ret

000026c8 <__fp_round>:
    26c8:	09 2e       	mov	r0, r25
    26ca:	03 94       	inc	r0
    26cc:	00 0c       	add	r0, r0
    26ce:	11 f4       	brne	.+4      	; 0x26d4 <__fp_round+0xc>
    26d0:	88 23       	and	r24, r24
    26d2:	52 f0       	brmi	.+20     	; 0x26e8 <__fp_round+0x20>
    26d4:	bb 0f       	add	r27, r27
    26d6:	40 f4       	brcc	.+16     	; 0x26e8 <__fp_round+0x20>
    26d8:	bf 2b       	or	r27, r31
    26da:	11 f4       	brne	.+4      	; 0x26e0 <__fp_round+0x18>
    26dc:	60 ff       	sbrs	r22, 0
    26de:	04 c0       	rjmp	.+8      	; 0x26e8 <__fp_round+0x20>
...
000026ea <__fp_split3>:
    26ea:	57 fd       	sbrc	r21, 7
    26ec:	90 58       	subi	r25, 0x80	; 128
    26ee:	44 0f       	add	r20, r20
    26f0:	55 1f       	adc	r21, r21
    26f2:	59 f0       	breq	.+22     	; 0x270a <__fp_splitA+0x10>
    26f4:	5f 3f       	cpi	r21, 0xFF	; 255
    26f6:	71 f0       	breq	.+28     	; 0x2714 <__fp_splitA+0x1a>
    26f8:	47 95       	ror	r20

000026fa <__fp_splitA>:
    26fa:	88 0f       	add	r24, r24
    26fc:	97 fb       	bst	r25, 7
    26fe:	99 1f       	adc	r25, r25
    2700:	61 f0       	breq	.+24     	; 0x271a <__fp_splitA+0x20>
    2702:	9f 3f       	cpi	r25, 0xFF	; 255
    2704:	79 f0       	breq	.+30     	; 0x2724 <__fp_splitA+0x2a>
    2706:	87 95       	ror	r24
    2708:	08 95       	ret
    ...
    2712:	f2 cf       	rjmp	.-28     	; 0x26f8 <__fp_split3+0xe>
    2714:	46 95       	lsr	r20
    2716:	f1 df       	rcall	.-30     	; 0x26fa <__fp_splitA>
    2718:	08 c0       	rjmp	.+16     	; 0x272a <__fp_splitA+0x30>
    271a:	16 16       	cp	r1, r22
    271c:	17 06       	cpc	r1, r23
    271e:	18 06       	cpc	r1, r24
    2720:	99 1f       	adc	r25, r25
    2722:	f1 cf       	rjmp	.-30     	; 0x2706 <__fp_splitA+0xc>
    2724:	86 95       	lsr	r24
...
0000273c <__mulsf3>:
    ...
    2740:	0c 94 64 13 	jmp	0x26c8	; 0x26c8 <__fp_round>
    2744:	0e 94 56 13 	call	0x26ac	; 0x26ac <__fp_pscA>
    2748:	38 f0       	brcs	.+14     	; 0x2758 <__mulsf3+0x1c>
    274a:	0e 94 5d 13 	call	0x26ba	; 0x26ba <__fp_pscB>
    274e:	20 f0       	brcs	.+8      	; 0x2758 <__mulsf3+0x1c>
    2750:	95 23       	and	r25, r21
    2752:	11 f0       	breq	.+4      	; 0x2758 <__mulsf3+0x1c>
    2754:	0c 94 4d 13 	jmp	0x269a	; 0x269a <__fp_inf>
    2758:	0c 94 53 13 	jmp	0x26a6	; 0x26a6 <__fp_nan>
    275c:	11 24       	eor	r1, r1
    275e:	0c 94 98 13 	jmp	0x2730	; 0x2730 <__fp_szero>

00002762 <__mulsf3x>:
    2762:	0e 94 75 13 	call	0x26ea	; 0x26ea <__fp_split3>
...
00002768 <__mulsf3_pse>:
    ...
    27e8:	0c 94 4d 13 	jmp	0x269a	; 0x269a <__fp_inf>
    27ec:	0c 94 98 13 	jmp	0x2730	; 0x2730 <__fp_szero>
...
00002816 <memcmp>:
    ...
    281a:	04 c0       	rjmp	.+8      	; 0x2824 <memcmp+0xe>
    281c:	8d 91       	ld	r24, X+
    281e:	01 90       	ld	r0, Z+
    2820:	80 19       	sub	r24, r0
    2822:	21 f4       	brne	.+8      	; 0x282c <memcmp+0x16>
    2824:	41 50       	subi	r20, 0x01	; 1
    2826:	50 40       	sbci	r21, 0x00	; 0
    2828:	c8 f7       	brcc	.-14     	; 0x281c <memcmp+0x6>
    282a:	88 1b       	sub	r24, r24
...
00002830 <strncpy>:
    ...
    2838:	48 f0       	brcs	.+18     	; 0x284c <strncpy+0x1c>
    283a:	01 90       	ld	r0, Z+
    283c:	0d 92       	st	X+, r0
    283e:	00 20       	and	r0, r0
    2840:	c9 f7       	brne	.-14     	; 0x2834 <strncpy+0x4>
    2842:	01 c0       	rjmp	.+2      	; 0x2846 <strncpy+0x16>
    2844:	1d 92       	st	X+, r1
    2846:	41 50       	subi	r20, 0x01	; 1
    2848:	50 40       	sbci	r21, 0x00	; 0
    284a:	e0 f7       	brcc	.-8      	; 0x2844 <strncpy+0x14>
    284c:	08 95       	ret

0000284e <vsnprintf>:
    284e:	ae e0       	ldi	r26, 0x0E	; 14
    2850:	b0 e0       	ldi	r27, 0x00	; 0
    2852:	ed e2       	ldi	r30, 0x2D	; 45
    2854:	f4 e1       	ldi	r31, 0x14	; 20
    2856:	0c 94 f2 16 	jmp	0x2de4	; 0x2de4 <__prologue_saves__+0x1c>
    285a:	8c 01       	movw	r16, r24
    285c:	fa 01       	movw	r30, r20
    285e:	86 e0       	ldi	r24, 0x06	; 6
    2860:	8c 83       	std	Y+4, r24	; 0x04
    2862:	09 83       	std	Y+1, r16	; 0x01
    2864:	1a 83       	std	Y+2, r17	; 0x02
    2866:	77 ff       	sbrs	r23, 7
    2868:	02 c0       	rjmp	.+4      	; 0x286e <vsnprintf+0x20>
    286a:	60 e0       	ldi	r22, 0x00	; 0
    286c:	70 e8       	ldi	r23, 0x80	; 128
    ...
    287e:	0e 94 53 14 	call	0x28a6	; 0x28a6 <vfprintf>
    2882:	4d 81       	ldd	r20, Y+5	; 0x05
    2884:	5e 81       	ldd	r21, Y+6	; 0x06
    2886:	57 fd       	sbrc	r21, 7
    2888:	0a c0       	rjmp	.+20     	; 0x289e <vsnprintf+0x50>
    288a:	2f 81       	ldd	r18, Y+7	; 0x07
    288c:	38 85       	ldd	r19, Y+8	; 0x08
    288e:	42 17       	cp	r20, r18
    2890:	53 07       	cpc	r21, r19
    2892:	0c f4       	brge	.+2      	; 0x2896 <vsnprintf+0x48>
    ...
    28a0:	e4 e0       	ldi	r30, 0x04	; 4
    28a2:	0c 94 0b 17 	jmp	0x2e16	; 0x2e16 <__epilogue_restores__+0x1c>
...
000028a6 <vfprintf>:
    ...
    28d0:	93 fd       	sbrc	r25, 3
    28d2:	85 91       	lpm	r24, Z+
    28d4:	93 ff       	sbrs	r25, 3
    28d6:	81 91       	ld	r24, Z+
    28d8:	7f 01       	movw	r14, r30
    28da:	88 23       	and	r24, r24
    28dc:	09 f4       	brne	.+2      	; 0x28e0 <vfprintf+0x3a>
    28de:	ba c1       	rjmp	.+884    	; 0x2c54 <vfprintf+0x3ae>
    28e0:	85 32       	cpi	r24, 0x25	; 37
    28e2:	39 f4       	brne	.+14     	; 0x28f2 <vfprintf+0x4c>
    28e4:	93 fd       	sbrc	r25, 3
    28e6:	85 91       	lpm	r24, Z+
    28e8:	93 ff       	sbrs	r25, 3
    28ea:	81 91       	ld	r24, Z+
    28ec:	7f 01       	movw	r14, r30
    28ee:	85 32       	cpi	r24, 0x25	; 37
    28f0:	29 f4       	brne	.+10     	; 0x28fc <vfprintf+0x56>
    28f2:	b6 01       	movw	r22, r12
    28f4:	90 e0       	ldi	r25, 0x00	; 0
    28f6:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    28fa:	e7 cf       	rjmp	.-50     	; 0x28ca <vfprintf+0x24>
    28fc:	91 2c       	mov	r9, r1
    28fe:	21 2c       	mov	r2, r1
    2900:	31 2c       	mov	r3, r1
    2902:	ff e1       	ldi	r31, 0x1F	; 31
    2904:	f3 15       	cp	r31, r3
    2906:	d8 f0       	brcs	.+54     	; 0x293e <vfprintf+0x98>
    2908:	8b 32       	cpi	r24, 0x2B	; 43
    290a:	79 f0       	breq	.+30     	; 0x292a <vfprintf+0x84>
    290c:	38 f4       	brcc	.+14     	; 0x291c <vfprintf+0x76>
    290e:	80 32       	cpi	r24, 0x20	; 32
    2910:	79 f0       	breq	.+30     	; 0x2930 <vfprintf+0x8a>
    2912:	83 32       	cpi	r24, 0x23	; 35
    2914:	a1 f4       	brne	.+40     	; 0x293e <vfprintf+0x98>
    2916:	23 2d       	mov	r18, r3
    2918:	20 61       	ori	r18, 0x10	; 16
    291a:	1d c0       	rjmp	.+58     	; 0x2956 <vfprintf+0xb0>
    291c:	8d 32       	cpi	r24, 0x2D	; 45
    291e:	61 f0       	breq	.+24     	; 0x2938 <vfprintf+0x92>
    2920:	80 33       	cpi	r24, 0x30	; 48
    2922:	69 f4       	brne	.+26     	; 0x293e <vfprintf+0x98>
    2924:	23 2d       	mov	r18, r3
    2926:	21 60       	ori	r18, 0x01	; 1
    2928:	16 c0       	rjmp	.+44     	; 0x2956 <vfprintf+0xb0>
    292a:	83 2d       	mov	r24, r3
    292c:	82 60       	ori	r24, 0x02	; 2
    292e:	38 2e       	mov	r3, r24
    2930:	e3 2d       	mov	r30, r3
    2932:	e4 60       	ori	r30, 0x04	; 4
    2934:	3e 2e       	mov	r3, r30
    2936:	2a c0       	rjmp	.+84     	; 0x298c <vfprintf+0xe6>
    2938:	f3 2d       	mov	r31, r3
    293a:	f8 60       	ori	r31, 0x08	; 8
    293c:	1d c0       	rjmp	.+58     	; 0x2978 <vfprintf+0xd2>
    293e:	37 fc       	sbrc	r3, 7
    2940:	2d c0       	rjmp	.+90     	; 0x299c <vfprintf+0xf6>
    2942:	20 ed       	ldi	r18, 0xD0	; 208
    2944:	28 0f       	add	r18, r24
    2946:	2a 30       	cpi	r18, 0x0A	; 10
    2948:	40 f0       	brcs	.+16     	; 0x295a <vfprintf+0xb4>
    294a:	8e 32       	cpi	r24, 0x2E	; 46
    294c:	b9 f4       	brne	.+46     	; 0x297c <vfprintf+0xd6>
    294e:	36 fc       	sbrc	r3, 6
    2950:	81 c1       	rjmp	.+770    	; 0x2c54 <vfprintf+0x3ae>
    2952:	23 2d       	mov	r18, r3
    2954:	20 64       	ori	r18, 0x40	; 64
    2956:	32 2e       	mov	r3, r18
    2958:	19 c0       	rjmp	.+50     	; 0x298c <vfprintf+0xe6>
    295a:	36 fe       	sbrs	r3, 6
    295c:	06 c0       	rjmp	.+12     	; 0x296a <vfprintf+0xc4>
    295e:	8a e0       	ldi	r24, 0x0A	; 10
    2960:	98 9e       	mul	r9, r24
    2962:	20 0d       	add	r18, r0
    2964:	11 24       	eor	r1, r1
    2966:	92 2e       	mov	r9, r18
    2968:	11 c0       	rjmp	.+34     	; 0x298c <vfprintf+0xe6>
    296a:	ea e0       	ldi	r30, 0x0A	; 10
    296c:	2e 9e       	mul	r2, r30
    296e:	20 0d       	add	r18, r0
    2970:	11 24       	eor	r1, r1
    2972:	22 2e       	mov	r2, r18
    2974:	f3 2d       	mov	r31, r3
    2976:	f0 62       	ori	r31, 0x20	; 32
    2978:	3f 2e       	mov	r3, r31
    297a:	08 c0       	rjmp	.+16     	; 0x298c <vfprintf+0xe6>
    297c:	8c 36       	cpi	r24, 0x6C	; 108
    297e:	21 f4       	brne	.+8      	; 0x2988 <vfprintf+0xe2>
    2980:	83 2d       	mov	r24, r3
    2982:	80 68       	ori	r24, 0x80	; 128
    2984:	38 2e       	mov	r3, r24
    2986:	02 c0       	rjmp	.+4      	; 0x298c <vfprintf+0xe6>
    2988:	88 36       	cpi	r24, 0x68	; 104
    298a:	41 f4       	brne	.+16     	; 0x299c <vfprintf+0xf6>
    ...
    299a:	b3 cf       	rjmp	.-154    	; 0x2902 <vfprintf+0x5c>
    299c:	98 2f       	mov	r25, r24
    299e:	9f 7d       	andi	r25, 0xDF	; 223
    29a0:	95 54       	subi	r25, 0x45	; 69
    29a2:	93 30       	cpi	r25, 0x03	; 3
    29a4:	28 f4       	brcc	.+10     	; 0x29b0 <vfprintf+0x10a>
    29a6:	0c 5f       	subi	r16, 0xFC	; 252
    29a8:	1f 4f       	sbci	r17, 0xFF	; 255
    29aa:	9f e3       	ldi	r25, 0x3F	; 63
    29ac:	99 83       	std	Y+1, r25	; 0x01
    29ae:	0d c0       	rjmp	.+26     	; 0x29ca <vfprintf+0x124>
    29b0:	83 36       	cpi	r24, 0x63	; 99
    29b2:	31 f0       	breq	.+12     	; 0x29c0 <vfprintf+0x11a>
    29b4:	83 37       	cpi	r24, 0x73	; 115
    29b6:	71 f0       	breq	.+28     	; 0x29d4 <vfprintf+0x12e>
    29b8:	83 35       	cpi	r24, 0x53	; 83
    29ba:	09 f0       	breq	.+2      	; 0x29be <vfprintf+0x118>
    29bc:	59 c0       	rjmp	.+178    	; 0x2a70 <vfprintf+0x1ca>
    29be:	21 c0       	rjmp	.+66     	; 0x2a02 <vfprintf+0x15c>
    29c0:	f8 01       	movw	r30, r16
    29c2:	80 81       	ld	r24, Z
    29c4:	89 83       	std	Y+1, r24	; 0x01
    29c6:	0e 5f       	subi	r16, 0xFE	; 254
    29c8:	1f 4f       	sbci	r17, 0xFF	; 255
    29ca:	88 24       	eor	r8, r8
    29cc:	83 94       	inc	r8
    29ce:	91 2c       	mov	r9, r1
    29d0:	53 01       	movw	r10, r6
    29d2:	13 c0       	rjmp	.+38     	; 0x29fa <vfprintf+0x154>
    29d4:	28 01       	movw	r4, r16
    29d6:	f2 e0       	ldi	r31, 0x02	; 2
    29d8:	4f 0e       	add	r4, r31
    29da:	51 1c       	adc	r5, r1
    29dc:	f8 01       	movw	r30, r16
    29de:	a0 80       	ld	r10, Z
    29e0:	b1 80       	ldd	r11, Z+1	; 0x01
    29e2:	36 fe       	sbrs	r3, 6
    29e4:	03 c0       	rjmp	.+6      	; 0x29ec <vfprintf+0x146>
    29e6:	69 2d       	mov	r22, r9
    29e8:	70 e0       	ldi	r23, 0x00	; 0
    29ea:	02 c0       	rjmp	.+4      	; 0x29f0 <vfprintf+0x14a>
    29ec:	6f ef       	ldi	r22, 0xFF	; 255
    29ee:	7f ef       	ldi	r23, 0xFF	; 255
    29f0:	c5 01       	movw	r24, r10
    29f2:	0e 94 3f 16 	call	0x2c7e	; 0x2c7e <strnlen>
    29f6:	4c 01       	movw	r8, r24
    29f8:	82 01       	movw	r16, r4
    29fa:	f3 2d       	mov	r31, r3
    29fc:	ff 77       	andi	r31, 0x7F	; 127
    29fe:	3f 2e       	mov	r3, r31
    2a00:	16 c0       	rjmp	.+44     	; 0x2a2e <vfprintf+0x188>
    2a02:	28 01       	movw	r4, r16
    2a04:	22 e0       	ldi	r18, 0x02	; 2
    2a06:	42 0e       	add	r4, r18
    2a08:	51 1c       	adc	r5, r1
    2a0a:	f8 01       	movw	r30, r16
    2a0c:	a0 80       	ld	r10, Z
    2a0e:	b1 80       	ldd	r11, Z+1	; 0x01
    2a10:	36 fe       	sbrs	r3, 6
    2a12:	03 c0       	rjmp	.+6      	; 0x2a1a <vfprintf+0x174>
    2a14:	69 2d       	mov	r22, r9
    2a16:	70 e0       	ldi	r23, 0x00	; 0
    2a18:	02 c0       	rjmp	.+4      	; 0x2a1e <vfprintf+0x178>
    2a1a:	6f ef       	ldi	r22, 0xFF	; 255
    2a1c:	7f ef       	ldi	r23, 0xFF	; 255
    2a1e:	c5 01       	movw	r24, r10
    2a20:	0e 94 34 16 	call	0x2c68	; 0x2c68 <strnlen_P>
    2a24:	4c 01       	movw	r8, r24
    2a26:	f3 2d       	mov	r31, r3
    2a28:	f0 68       	ori	r31, 0x80	; 128
    2a2a:	3f 2e       	mov	r3, r31
    2a2c:	82 01       	movw	r16, r4
    2a2e:	33 fc       	sbrc	r3, 3
    2a30:	1b c0       	rjmp	.+54     	; 0x2a68 <vfprintf+0x1c2>
    2a32:	82 2d       	mov	r24, r2
    2a34:	90 e0       	ldi	r25, 0x00	; 0
    2a36:	88 16       	cp	r8, r24
    2a38:	99 06       	cpc	r9, r25
    2a3a:	b0 f4       	brcc	.+44     	; 0x2a68 <vfprintf+0x1c2>
    2a3c:	b6 01       	movw	r22, r12
    2a3e:	80 e2       	ldi	r24, 0x20	; 32
    2a40:	90 e0       	ldi	r25, 0x00	; 0
    2a42:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2a46:	2a 94       	dec	r2
    2a48:	f4 cf       	rjmp	.-24     	; 0x2a32 <vfprintf+0x18c>
    2a4a:	f5 01       	movw	r30, r10
    2a4c:	37 fc       	sbrc	r3, 7
    2a4e:	85 91       	lpm	r24, Z+
    2a50:	37 fe       	sbrs	r3, 7
    2a52:	81 91       	ld	r24, Z+
    2a54:	5f 01       	movw	r10, r30
    2a56:	b6 01       	movw	r22, r12
    2a58:	90 e0       	ldi	r25, 0x00	; 0
    2a5a:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2a5e:	21 10       	cpse	r2, r1
    2a60:	2a 94       	dec	r2
    2a62:	21 e0       	ldi	r18, 0x01	; 1
    2a64:	82 1a       	sub	r8, r18
    2a66:	91 08       	sbc	r9, r1
    2a68:	81 14       	cp	r8, r1
    2a6a:	91 04       	cpc	r9, r1
    2a6c:	71 f7       	brne	.-36     	; 0x2a4a <vfprintf+0x1a4>
    2a6e:	e8 c0       	rjmp	.+464    	; 0x2c40 <vfprintf+0x39a>
    2a70:	84 36       	cpi	r24, 0x64	; 100
    2a72:	11 f0       	breq	.+4      	; 0x2a78 <vfprintf+0x1d2>
    2a74:	89 36       	cpi	r24, 0x69	; 105
    2a76:	41 f5       	brne	.+80     	; 0x2ac8 <vfprintf+0x222>
    2a78:	f8 01       	movw	r30, r16
    2a7a:	37 fe       	sbrs	r3, 7
    2a7c:	07 c0       	rjmp	.+14     	; 0x2a8c <vfprintf+0x1e6>
    2a7e:	60 81       	ld	r22, Z
    2a80:	71 81       	ldd	r23, Z+1	; 0x01
    2a82:	82 81       	ldd	r24, Z+2	; 0x02
    2a84:	93 81       	ldd	r25, Z+3	; 0x03
    2a86:	0c 5f       	subi	r16, 0xFC	; 252
    2a88:	1f 4f       	sbci	r17, 0xFF	; 255
    2a8a:	08 c0       	rjmp	.+16     	; 0x2a9c <vfprintf+0x1f6>
    2a8c:	60 81       	ld	r22, Z
    2a8e:	71 81       	ldd	r23, Z+1	; 0x01
    2a90:	07 2e       	mov	r0, r23
    2a92:	00 0c       	add	r0, r0
    2a94:	88 0b       	sbc	r24, r24
    2a96:	99 0b       	sbc	r25, r25
    2a98:	0e 5f       	subi	r16, 0xFE	; 254
    2a9a:	1f 4f       	sbci	r17, 0xFF	; 255
    2a9c:	f3 2d       	mov	r31, r3
    2a9e:	ff 76       	andi	r31, 0x6F	; 111
    2aa0:	3f 2e       	mov	r3, r31
    2aa2:	97 ff       	sbrs	r25, 7
    2aa4:	09 c0       	rjmp	.+18     	; 0x2ab8 <vfprintf+0x212>
    2aa6:	90 95       	com	r25
    2aa8:	80 95       	com	r24
    2aaa:	70 95       	com	r23
    2aac:	61 95       	neg	r22
    ...
    2ab4:	f0 68       	ori	r31, 0x80	; 128
    2ab6:	3f 2e       	mov	r3, r31
    2ab8:	2a e0       	ldi	r18, 0x0A	; 10
    2aba:	30 e0       	ldi	r19, 0x00	; 0
    2abc:	a3 01       	movw	r20, r6
    2abe:	0e 94 86 16 	call	0x2d0c	; 0x2d0c <__ultoa_invert>
    2ac2:	88 2e       	mov	r8, r24
    2ac4:	86 18       	sub	r8, r6
    2ac6:	45 c0       	rjmp	.+138    	; 0x2b52 <vfprintf+0x2ac>
    2ac8:	85 37       	cpi	r24, 0x75	; 117
    2aca:	31 f4       	brne	.+12     	; 0x2ad8 <vfprintf+0x232>
    ...
    2ad6:	25 c0       	rjmp	.+74     	; 0x2b22 <vfprintf+0x27c>
    2ad8:	93 2d       	mov	r25, r3
    2ada:	99 7f       	andi	r25, 0xF9	; 249
    2adc:	b9 2e       	mov	r11, r25
    2ade:	8f 36       	cpi	r24, 0x6F	; 111
    2ae0:	c1 f0       	breq	.+48     	; 0x2b12 <vfprintf+0x26c>
    2ae2:	18 f4       	brcc	.+6      	; 0x2aea <vfprintf+0x244>
    2ae4:	88 35       	cpi	r24, 0x58	; 88
    2ae6:	79 f0       	breq	.+30     	; 0x2b06 <vfprintf+0x260>
    2ae8:	b5 c0       	rjmp	.+362    	; 0x2c54 <vfprintf+0x3ae>
    2aea:	80 37       	cpi	r24, 0x70	; 112
    2aec:	19 f0       	breq	.+6      	; 0x2af4 <vfprintf+0x24e>
    2aee:	88 37       	cpi	r24, 0x78	; 120
    2af0:	21 f0       	breq	.+8      	; 0x2afa <vfprintf+0x254>
    2af2:	b0 c0       	rjmp	.+352    	; 0x2c54 <vfprintf+0x3ae>
    2af4:	e9 2f       	mov	r30, r25
    2af6:	e0 61       	ori	r30, 0x10	; 16
    2af8:	be 2e       	mov	r11, r30
    2afa:	b4 fe       	sbrs	r11, 4
    2afc:	0d c0       	rjmp	.+26     	; 0x2b18 <vfprintf+0x272>
    2afe:	fb 2d       	mov	r31, r11
    2b00:	f4 60       	ori	r31, 0x04	; 4
    2b02:	bf 2e       	mov	r11, r31
    2b04:	09 c0       	rjmp	.+18     	; 0x2b18 <vfprintf+0x272>
    2b06:	34 fe       	sbrs	r3, 4
    2b08:	0a c0       	rjmp	.+20     	; 0x2b1e <vfprintf+0x278>
    2b0a:	29 2f       	mov	r18, r25
    2b0c:	26 60       	ori	r18, 0x06	; 6
    2b0e:	b2 2e       	mov	r11, r18
    2b10:	06 c0       	rjmp	.+12     	; 0x2b1e <vfprintf+0x278>
    2b12:	28 e0       	ldi	r18, 0x08	; 8
    2b14:	30 e0       	ldi	r19, 0x00	; 0
    2b16:	05 c0       	rjmp	.+10     	; 0x2b22 <vfprintf+0x27c>
    2b18:	20 e1       	ldi	r18, 0x10	; 16
    2b1a:	30 e0       	ldi	r19, 0x00	; 0
    2b1c:	02 c0       	rjmp	.+4      	; 0x2b22 <vfprintf+0x27c>
    2b1e:	20 e1       	ldi	r18, 0x10	; 16
    2b20:	32 e0       	ldi	r19, 0x02	; 2
    2b22:	f8 01       	movw	r30, r16
    2b24:	b7 fe       	sbrs	r11, 7
    2b26:	07 c0       	rjmp	.+14     	; 0x2b36 <vfprintf+0x290>
    2b28:	60 81       	ld	r22, Z
    ...
    2b34:	06 c0       	rjmp	.+12     	; 0x2b42 <vfprintf+0x29c>
    2b36:	60 81       	ld	r22, Z
    ...
    2b44:	0e 94 86 16 	call	0x2d0c	; 0x2d0c <__ultoa_invert>
    2b48:	88 2e       	mov	r8, r24
    2b4a:	86 18       	sub	r8, r6
    2b4c:	fb 2d       	mov	r31, r11
    2b4e:	ff 77       	andi	r31, 0x7F	; 127
    2b50:	3f 2e       	mov	r3, r31
    2b52:	36 fe       	sbrs	r3, 6
    2b54:	0d c0       	rjmp	.+26     	; 0x2b70 <vfprintf+0x2ca>
    2b56:	23 2d       	mov	r18, r3
    2b58:	2e 7f       	andi	r18, 0xFE	; 254
    2b5a:	a2 2e       	mov	r10, r18
    2b5c:	89 14       	cp	r8, r9
    2b5e:	58 f4       	brcc	.+22     	; 0x2b76 <vfprintf+0x2d0>
    2b60:	34 fe       	sbrs	r3, 4
    2b62:	0b c0       	rjmp	.+22     	; 0x2b7a <vfprintf+0x2d4>
    2b64:	32 fc       	sbrc	r3, 2
    2b66:	09 c0       	rjmp	.+18     	; 0x2b7a <vfprintf+0x2d4>
    2b68:	83 2d       	mov	r24, r3
    2b6a:	8e 7e       	andi	r24, 0xEE	; 238
    2b6c:	a8 2e       	mov	r10, r24
    2b6e:	05 c0       	rjmp	.+10     	; 0x2b7a <vfprintf+0x2d4>
    2b70:	b8 2c       	mov	r11, r8
    2b72:	a3 2c       	mov	r10, r3
    2b74:	03 c0       	rjmp	.+6      	; 0x2b7c <vfprintf+0x2d6>
    2b76:	b8 2c       	mov	r11, r8
    2b78:	01 c0       	rjmp	.+2      	; 0x2b7c <vfprintf+0x2d6>
    2b7a:	b9 2c       	mov	r11, r9
    2b7c:	a4 fe       	sbrs	r10, 4
    2b7e:	0f c0       	rjmp	.+30     	; 0x2b9e <vfprintf+0x2f8>
    2b80:	fe 01       	movw	r30, r28
    2b82:	e8 0d       	add	r30, r8
    2b84:	f1 1d       	adc	r31, r1
    2b86:	80 81       	ld	r24, Z
    2b88:	80 33       	cpi	r24, 0x30	; 48
    2b8a:	21 f4       	brne	.+8      	; 0x2b94 <vfprintf+0x2ee>
    2b8c:	9a 2d       	mov	r25, r10
    2b8e:	99 7e       	andi	r25, 0xE9	; 233
    2b90:	a9 2e       	mov	r10, r25
    2b92:	09 c0       	rjmp	.+18     	; 0x2ba6 <vfprintf+0x300>
    2b94:	a2 fe       	sbrs	r10, 2
    2b96:	06 c0       	rjmp	.+12     	; 0x2ba4 <vfprintf+0x2fe>
    2b98:	b3 94       	inc	r11
    2b9a:	b3 94       	inc	r11
    2b9c:	04 c0       	rjmp	.+8      	; 0x2ba6 <vfprintf+0x300>
    2b9e:	8a 2d       	mov	r24, r10
    2ba0:	86 78       	andi	r24, 0x86	; 134
    2ba2:	09 f0       	breq	.+2      	; 0x2ba6 <vfprintf+0x300>
    2ba4:	b3 94       	inc	r11
    2ba6:	a3 fc       	sbrc	r10, 3
    2ba8:	11 c0       	rjmp	.+34     	; 0x2bcc <vfprintf+0x326>
    2baa:	a0 fe       	sbrs	r10, 0
    2bac:	06 c0       	rjmp	.+12     	; 0x2bba <vfprintf+0x314>
    2bae:	b2 14       	cp	r11, r2
    2bb0:	88 f4       	brcc	.+34     	; 0x2bd4 <vfprintf+0x32e>
    2bb2:	28 0c       	add	r2, r8
    2bb4:	92 2c       	mov	r9, r2
    2bb6:	9b 18       	sub	r9, r11
    2bb8:	0e c0       	rjmp	.+28     	; 0x2bd6 <vfprintf+0x330>
    2bba:	b2 14       	cp	r11, r2
    2bbc:	60 f4       	brcc	.+24     	; 0x2bd6 <vfprintf+0x330>
    2bbe:	b6 01       	movw	r22, r12
    2bc0:	80 e2       	ldi	r24, 0x20	; 32
    2bc2:	90 e0       	ldi	r25, 0x00	; 0
    2bc4:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2bc8:	b3 94       	inc	r11
    2bca:	f7 cf       	rjmp	.-18     	; 0x2bba <vfprintf+0x314>
    2bcc:	b2 14       	cp	r11, r2
    2bce:	18 f4       	brcc	.+6      	; 0x2bd6 <vfprintf+0x330>
    2bd0:	2b 18       	sub	r2, r11
    2bd2:	02 c0       	rjmp	.+4      	; 0x2bd8 <vfprintf+0x332>
    2bd4:	98 2c       	mov	r9, r8
    2bd6:	21 2c       	mov	r2, r1
    2bd8:	a4 fe       	sbrs	r10, 4
    2bda:	10 c0       	rjmp	.+32     	; 0x2bfc <vfprintf+0x356>
    2bdc:	b6 01       	movw	r22, r12
    2bde:	80 e3       	ldi	r24, 0x30	; 48
    2be0:	90 e0       	ldi	r25, 0x00	; 0
    2be2:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2be6:	a2 fe       	sbrs	r10, 2
    2be8:	17 c0       	rjmp	.+46     	; 0x2c18 <vfprintf+0x372>
    2bea:	a1 fc       	sbrc	r10, 1
    2bec:	03 c0       	rjmp	.+6      	; 0x2bf4 <vfprintf+0x34e>
    2bee:	88 e7       	ldi	r24, 0x78	; 120
    2bf0:	90 e0       	ldi	r25, 0x00	; 0
    2bf2:	02 c0       	rjmp	.+4      	; 0x2bf8 <vfprintf+0x352>
    2bf4:	88 e5       	ldi	r24, 0x58	; 88
    2bf6:	90 e0       	ldi	r25, 0x00	; 0
    2bf8:	b6 01       	movw	r22, r12
    2bfa:	0c c0       	rjmp	.+24     	; 0x2c14 <vfprintf+0x36e>
    2bfc:	8a 2d       	mov	r24, r10
    2bfe:	86 78       	andi	r24, 0x86	; 134
    2c00:	59 f0       	breq	.+22     	; 0x2c18 <vfprintf+0x372>
    2c02:	a1 fe       	sbrs	r10, 1
    2c04:	02 c0       	rjmp	.+4      	; 0x2c0a <vfprintf+0x364>
    2c06:	8b e2       	ldi	r24, 0x2B	; 43
    2c08:	01 c0       	rjmp	.+2      	; 0x2c0c <vfprintf+0x366>
    2c0a:	80 e2       	ldi	r24, 0x20	; 32
    2c0c:	a7 fc       	sbrc	r10, 7
    2c0e:	8d e2       	ldi	r24, 0x2D	; 45
    2c10:	b6 01       	movw	r22, r12
    2c12:	90 e0       	ldi	r25, 0x00	; 0
    2c14:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2c18:	89 14       	cp	r8, r9
    2c1a:	38 f4       	brcc	.+14     	; 0x2c2a <vfprintf+0x384>
    2c1c:	b6 01       	movw	r22, r12
    2c1e:	80 e3       	ldi	r24, 0x30	; 48
    2c20:	90 e0       	ldi	r25, 0x00	; 0
    2c22:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2c26:	9a 94       	dec	r9
    2c28:	f7 cf       	rjmp	.-18     	; 0x2c18 <vfprintf+0x372>
    2c2a:	8a 94       	dec	r8
    2c2c:	f3 01       	movw	r30, r6
    2c2e:	e8 0d       	add	r30, r8
    2c30:	f1 1d       	adc	r31, r1
    2c32:	80 81       	ld	r24, Z
    2c34:	b6 01       	movw	r22, r12
    2c36:	90 e0       	ldi	r25, 0x00	; 0
    2c38:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2c3c:	81 10       	cpse	r8, r1
    2c3e:	f5 cf       	rjmp	.-22     	; 0x2c2a <vfprintf+0x384>
    2c40:	22 20       	and	r2, r2
    2c42:	09 f4       	brne	.+2      	; 0x2c46 <vfprintf+0x3a0>
    2c44:	42 ce       	rjmp	.-892    	; 0x28ca <vfprintf+0x24>
    2c46:	b6 01       	movw	r22, r12
    2c48:	80 e2       	ldi	r24, 0x20	; 32
    2c4a:	90 e0       	ldi	r25, 0x00	; 0
    2c4c:	0e 94 4a 16 	call	0x2c94	; 0x2c94 <fputc>
    2c50:	2a 94       	dec	r2
    2c52:	f6 cf       	rjmp	.-20     	; 0x2c40 <vfprintf+0x39a>
    2c54:	f6 01       	movw	r30, r12
    2c56:	86 81       	ldd	r24, Z+6	; 0x06
    2c58:	97 81       	ldd	r25, Z+7	; 0x07
    2c5a:	02 c0       	rjmp	.+4      	; 0x2c60 <vfprintf+0x3ba>
    2c5c:	8f ef       	ldi	r24, 0xFF	; 255
    2c5e:	9f ef       	ldi	r25, 0xFF	; 255
    2c60:	2b 96       	adiw	r28, 0x0b	; 11
    2c62:	e2 e1       	ldi	r30, 0x12	; 18
    2c64:	0c 94 fd 16 	jmp	0x2dfa	; 0x2dfa <__epilogue_restores__>
...
00002c94 <fputc>:
    ...
    2c9e:	23 81       	ldd	r18, Z+3	; 0x03
    2ca0:	21 fd       	sbrc	r18, 1
    2ca2:	03 c0       	rjmp	.+6      	; 0x2caa <fputc+0x16>
    2ca4:	8f ef       	ldi	r24, 0xFF	; 255
    2ca6:	9f ef       	ldi	r25, 0xFF	; 255
    2ca8:	2c c0       	rjmp	.+88     	; 0x2d02 <fputc+0x6e>
    2caa:	22 ff       	sbrs	r18, 2
    2cac:	16 c0       	rjmp	.+44     	; 0x2cda <fputc+0x46>
    2cae:	46 81       	ldd	r20, Z+6	; 0x06
    2cb0:	57 81       	ldd	r21, Z+7	; 0x07
    2cb2:	24 81       	ldd	r18, Z+4	; 0x04
    2cb4:	35 81       	ldd	r19, Z+5	; 0x05
    2cb6:	42 17       	cp	r20, r18
    2cb8:	53 07       	cpc	r21, r19
    2cba:	44 f4       	brge	.+16     	; 0x2ccc <fputc+0x38>
    2cbc:	a0 81       	ld	r26, Z
    2cbe:	b1 81       	ldd	r27, Z+1	; 0x01
    2cc0:	9d 01       	movw	r18, r26
    2cc2:	2f 5f       	subi	r18, 0xFF	; 255
    2cc4:	3f 4f       	sbci	r19, 0xFF	; 255
    2cc6:	20 83       	st	Z, r18
    2cc8:	31 83       	std	Z+1, r19	; 0x01
    2cca:	8c 93       	st	X, r24
    2ccc:	26 81       	ldd	r18, Z+6	; 0x06
    2cce:	37 81       	ldd	r19, Z+7	; 0x07
    2cd0:	2f 5f       	subi	r18, 0xFF	; 255
    2cd2:	3f 4f       	sbci	r19, 0xFF	; 255
    2cd4:	26 83       	std	Z+6, r18	; 0x06
    2cd6:	37 83       	std	Z+7, r19	; 0x07
    2cd8:	14 c0       	rjmp	.+40     	; 0x2d02 <fputc+0x6e>
    2cda:	8b 01       	movw	r16, r22
    2cdc:	ec 01       	movw	r28, r24
    2cde:	fb 01       	movw	r30, r22
    2ce0:	00 84       	ldd	r0, Z+8	; 0x08
    2ce2:	f1 85       	ldd	r31, Z+9	; 0x09
    2ce4:	e0 2d       	mov	r30, r0
    2ce6:	09 95       	icall
    2ce8:	89 2b       	or	r24, r25
    2cea:	e1 f6       	brne	.-72     	; 0x2ca4 <fputc+0x10>
    2cec:	d8 01       	movw	r26, r16
    2cee:	16 96       	adiw	r26, 0x06	; 6
    2cf0:	8d 91       	ld	r24, X+
    2cf2:	9c 91       	ld	r25, X
    2cf4:	17 97       	sbiw	r26, 0x07	; 7
    2cf6:	01 96       	adiw	r24, 0x01	; 1
    2cf8:	16 96       	adiw	r26, 0x06	; 6
    2cfa:	8d 93       	st	X+, r24
    2cfc:	9c 93       	st	X, r25
    2cfe:	17 97       	sbiw	r26, 0x07	; 7
...
00002d0c <__ultoa_invert>:
    2d0c:	fa 01       	movw	r30, r20
    2d0e:	aa 27       	eor	r26, r26
    2d10:	28 30       	cpi	r18, 0x08	; 8
    2d12:	51 f1       	breq	.+84     	; 0x2d68 <__ultoa_invert+0x5c>
    2d14:	20 31       	cpi	r18, 0x10	; 16
    2d16:	81 f1       	breq	.+96     	; 0x2d78 <__ultoa_invert+0x6c>
    2d18:	e8 94       	clt
    2d1a:	6f 93       	push	r22
    2d1c:	6e 7f       	andi	r22, 0xFE	; 254
    2d1e:	6e 5f       	subi	r22, 0xFE	; 254
    2d20:	7f 4f       	sbci	r23, 0xFF	; 255
    2d22:	8f 4f       	sbci	r24, 0xFF	; 255
    2d24:	9f 4f       	sbci	r25, 0xFF	; 255
    2d26:	af 4f       	sbci	r26, 0xFF	; 255
    2d28:	b1 e0       	ldi	r27, 0x01	; 1
    2d2a:	3e d0       	rcall	.+124    	; 0x2da8 <__ultoa_invert+0x9c>
    2d2c:	b4 e0       	ldi	r27, 0x04	; 4
    2d2e:	3c d0       	rcall	.+120    	; 0x2da8 <__ultoa_invert+0x9c>
    2d30:	67 0f       	add	r22, r23
    2d32:	78 1f       	adc	r23, r24
    2d34:	89 1f       	adc	r24, r25
    2d36:	9a 1f       	adc	r25, r26
    2d38:	a1 1d       	adc	r26, r1
    2d3a:	68 0f       	add	r22, r24
    2d3c:	79 1f       	adc	r23, r25
    2d3e:	8a 1f       	adc	r24, r26
    2d40:	91 1d       	adc	r25, r1
    2d42:	a1 1d       	adc	r26, r1
    2d44:	6a 0f       	add	r22, r26
    2d46:	71 1d       	adc	r23, r1
    2d48:	81 1d       	adc	r24, r1
    2d4a:	91 1d       	adc	r25, r1
    2d4c:	a1 1d       	adc	r26, r1
    2d4e:	20 d0       	rcall	.+64     	; 0x2d90 <__ultoa_invert+0x84>
    2d50:	09 f4       	brne	.+2      	; 0x2d54 <__ultoa_invert+0x48>
    2d52:	68 94       	set
    2d54:	3f 91       	pop	r19
    2d56:	2a e0       	ldi	r18, 0x0A	; 10
    2d58:	26 9f       	mul	r18, r22
    2d5a:	11 24       	eor	r1, r1
    2d5c:	30 19       	sub	r19, r0
    2d5e:	30 5d       	subi	r19, 0xD0	; 208
    2d60:	31 93       	st	Z+, r19
    2d62:	de f6       	brtc	.-74     	; 0x2d1a <__ultoa_invert+0xe>
    2d64:	cf 01       	movw	r24, r30
    2d66:	08 95       	ret
    2d68:	46 2f       	mov	r20, r22
    2d6a:	47 70       	andi	r20, 0x07	; 7
    2d6c:	40 5d       	subi	r20, 0xD0	; 208
    2d6e:	41 93       	st	Z+, r20
    2d70:	b3 e0       	ldi	r27, 0x03	; 3
    2d72:	0f d0       	rcall	.+30     	; 0x2d92 <__ultoa_invert+0x86>
    2d74:	c9 f7       	brne	.-14     	; 0x2d68 <__ultoa_invert+0x5c>
    2d76:	f6 cf       	rjmp	.-20     	; 0x2d64 <__ultoa_invert+0x58>
    2d78:	46 2f       	mov	r20, r22
    2d7a:	4f 70       	andi	r20, 0x0F	; 15
    2d7c:	40 5d       	subi	r20, 0xD0	; 208
    2d7e:	4a 33       	cpi	r20, 0x3A	; 58
    2d80:	18 f0       	brcs	.+6      	; 0x2d88 <__ultoa_invert+0x7c>
    2d82:	49 5d       	subi	r20, 0xD9	; 217
    2d84:	31 fd       	sbrc	r19, 1
    2d86:	40 52       	subi	r20, 0x20	; 32
    2d88:	41 93       	st	Z+, r20
    2d8a:	02 d0       	rcall	.+4      	; 0x2d90 <__ultoa_invert+0x84>
    2d8c:	a9 f7       	brne	.-22     	; 0x2d78 <__ultoa_invert+0x6c>
    2d8e:	ea cf       	rjmp	.-44     	; 0x2d64 <__ultoa_invert+0x58>
    ...
    2d9a:	67 95       	ror	r22
    2d9c:	ba 95       	dec	r27
    2d9e:	c9 f7       	brne	.-14     	; 0x2d92 <__ultoa_invert+0x86>
    ...
    2db6:	27 95       	ror	r18
    2db8:	ba 95       	dec	r27
    2dba:	c9 f7       	brne	.-14     	; 0x2dae <__ultoa_invert+0xa2>
    2dbc:	62 0f       	add	r22, r18
    2dbe:	73 1f       	adc	r23, r19
    2dc0:	84 1f       	adc	r24, r20
    2dc2:	95 1f       	adc	r25, r21
    2dc4:	a0 1d       	adc	r26, r0
    2dc6:	08 95       	ret
